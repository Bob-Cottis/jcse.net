...
<SCRIPT src="/getcomm.php?vol=2&pap=30"></SCRIPT>
...
<script src="/jsinc/writeheader.js"></script><?php ggl_ad(); ?>
    ...
    <p align="left"><i>A.M. Mierisch and S.R. Taylor</i></p>
    <p align="left">Center for Electrochemical Science and Engineering,
...
<SCRIPT>notify();</SCRIPT><SCRIPT>comment(1)</SCRIPT>    <h3>Abstract</h3>
    ...
    <h3>Introduction</h3>
    <SCRIPT>comment(2)</SCRIPT><p>The initial sites of corrosion on organically coated alloy substrates are
    likely governed by either chemical heterogeneities within the organic
    coating [1], heterogeneities within the alloy (e.g. intermetallics) [2-4],
    ...
    on the local chemical and electrochemical processes.</p>
    <SCRIPT>comment(3)</SCRIPT><p>Traditionally, the electrochemical investigation of organic coating
    ...
    electrochemical events at these breakdown sites[11-16].</p>
    <SCRIPT>comment(4)</SCRIPT><p>This paper presents several observations of local electrochemical events
    ...
    corrosion.</p>
    <h3><b>Experimental Methods</b></h3>
    <SCRIPT>comment(5)</SCRIPT><p>The&nbsp; LEIM/S system used in this investigation employed the
    five-electrode (split micro-reference electrode) configuration originally
    designed by Lillard, Isaacs, and Moran [14], and further developed for
    specific use on local defects in coated alloys [16] as described in detail
    by Mierisch [15].&nbsp; The probe uses a 5-electrode configuration with two
    ...
    maintain a nondestructive character.</p>
    <SCRIPT>comment(6)</SCRIPT><p>All electrochemical measurements were performed on 1 mm thick AA2024-T3
    ...
    was used as a solvent to adjust viscosity in coatings (c) and (d).</p>
    <SCRIPT>comment(7)</SCRIPT><p>All panels were cleaned prior to coating by the following procedure and
    ...
    0.1 M NaCl and 0.1 M KCl were used as needed.</p>
    <h3><b>Results and Discussion</b></h3>
    <h4>Types of Defects</h4>
    <SCRIPT>comment(8)</SCRIPT><p>An important observation made in early investigations [15] was that
    ...
    thickness and exposed to 0.6 NaCl. (<a href="../paper30/v2p30f1large.gif">larger image</a>)</p>
    <SCRIPT>comment(10)</SCRIPT><p>It should be noted that these types of blister (i.e. red and black) were
    ...
    microscope. (<a href="../paper30/v2p30f2large.gif">larger image</a>)</p>
    <SCRIPT>comment(12)</SCRIPT><p>It was hypothesized that LEIM/S could predict which initial defects might
    ...
    resistance. (<a href="../paper30/v2p30f3large.gif">larger image</a>)</p>
    <SCRIPT>comment(14)</SCRIPT><p>In addition to differences in electrochemical activity, the blisters were
    ...
    capillary electrophoresis (CE)[14]. Cu<sup>2+</sup>, Al<sup>3+</sup>, and Mg<sup>2+</sup>
    ions were found in the solution of the red blisters whereas only small
    amounts of Mg<sup>2+</sup> and Zn<sup>2+</sup> were found in the black
    ...
    blisters can be quantified and characterized.&nbsp;</p>
    <SCRIPT>comment(15)</SCRIPT><p>Differences in underfilm pH and potential also differentiate these
    ...
    nondestructive LEIM technique.</p>
    ...
    possible breach in the coating. (<a href="../paper30/v2p30f4large.gif">larger image</a>)</p>
    <SCRIPT>comment(17)</SCRIPT><p>Red blisters generally show metastable behavior, with periods of
    ...
    suggested in the literature [18]but has not been specifically
    investigated.&nbsp; It has been suggested [19] that the biphasic nature
    ...
    will be discussed in a future paper.</p>
    <SCRIPT>comment(18)</SCRIPT><p>In later stages, metastability is visually observable as growth
    ...
    the blisters and could contribute to metastability.</p>
    <SCRIPT>comment(19)</SCRIPT><p>Repassivation, or �healing� has been suggested to occur on chromate
    conversion coated (CCC) aluminum alloys and cited as an asset of these
    coatings [20].&nbsp; LEIM was used to study the effect of chromate added to
    ...
    alone does not indicate this change. (<a href="../paper30/v2p30f5large.gif">larger
    image</a>)
    <SCRIPT>comment(21)</SCRIPT><p>Once the chromate was added, the open circuit potential rose to a more
    ...
    <SCRIPT>comment(22)</SCRIPT><p>&nbsp;In addition to characterizing overall properties of individual
    ...
    the higher activity in the initiation region. (<a href="../paper30/v2p30f6large.gif">larger
    image</a>)
    <SCRIPT>comment(24)</SCRIPT><p>Energy dispersive spectroscopy (EDS) also revealed a higher amount of Cu
    ...
    presently under investigation.</p>
    <h4>Early Stages of Defect Formation</h4>
    <SCRIPT>comment(25)</SCRIPT><p>Whereas later stages of blister development can be characterized by
    ...
    0.6 M NaCl solution.</p>
    <SCRIPT>comment(27)</SCRIPT><p>Several explanations for this increase in impedance have been
    ...
    edge effects and the dip does not extend below the baseline of the surface.</p>
    <h3>Conclusions</h3>
    <SCRIPT>comment(29)</SCRIPT><p>The local nature of corrosion of coated alloys necessitates the use of
    local electrochemical and chemical techniques toward understanding
    individual breakdown events.&nbsp; LEIM/S is capable of characterizing <i>in
    situ </i>the initiation of and changes in electrochemical activity of a
    ...
    behavior.</p>
    <SCRIPT>comment(30)</SCRIPT><p>LEIM has identified several different types of defects on coated
    ...
    the red blisters contained&nbsp; Cu<sup>2+</sup>, Al<sup>3+</sup>, and Mg<sup>2+</sup>
    ions whereas the black blister only contained small amounts of Mg<sup>2+</sup>
    and Zn<sup>2+</sup> ions.&nbsp; LEIM showed that red blisters often
    ...
    severe amount of damage to the substrate as compared to black blisters.</p>
    <SCRIPT>comment(31)</SCRIPT><p>The metastable nature of defects on the coated panels was monitored by
    ...
    addition of chromates, LEIM showed that repassivation was only temporary.</p>
    <SCRIPT>comment(32)</SCRIPT><p>Red blisters were observed to initiate in a given region and branch into
    ...
    secondary lobes.</p>
    <SCRIPT>comment(33)</SCRIPT><p>LEIM revealed an initial increase in impedance of blisters in the
    ...
    were located through LEIM of the substrate surface.</p>
    <h3>Acknowledgements</h3>
    <SCRIPT>comment(34)</SCRIPT><p>The authors would like to thank the Air Force Office of Scientific
    Research (AFOSR) for their sponsorship of this project as well as Jiangnan
    Yuan and Robert Kelly for their contributions of CE analysis.</p>
    <h3>References</h3>
    <SCRIPT>comment(35)</SCRIPT><p>1.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; J.E.O. Mayne, D.J. Mills, <i>J. Oil Col
    Chem Assoc.,</i> <b>58</b>:155 (1975).</p>
    <p>2.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; G.S. Chen, M Gao and R.P. Wei, <i>Corrosion</i>,
    <b>52</b>(1):8 (1996).</p>
    <p>3.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; P.Schmutz and G.S. Frankel, <i>J.
    Electrochem. Soc.,</i> <b>145</b>(7):2295 (1998).</p>
    <p>4.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; K. Nisancioglu,<i> J. Electrochem. Soc.,
    </i><b>137</b>(1):69 (1990).</p>
    <p>5.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; H. Leidheiser, Jr., <i>Corrosion</i>, <b>39</b>(5):189
    (1983).</p>
    <p>6.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; F. Mansfeld, M.W. Kendig, S.Tasi, <i>Corros.
    Sci.,</i> <b>23</b>(4):317 (1983).</p>
    <p>7.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; S.R. Taylor, <i>IEEE Trans. Elec. Insul.,</i>
    <b>24</b>(5):787 (1989).</p>
    <p>8.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; S. Haruyama, M. Asari, Tsuru, �Corrosion
    Protection by Organic Coatings�, The Electrochemical Society, Proc. 87-2
    (1987), p.197.</p>
    <p>9.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; S. Hirayama, S. Haruyama, <i>Corrosion,</i>
    <b>47</b>(12):953 (1991).</p>
    <p>10.&nbsp; C.T. Chen and B.S. Skerry, <i>Corrosion</i>, <b>47</b>(8):598
    (1991).</p>
    <p>11.&nbsp; I. Annergren, D. Thierry, F. Zou, <i>J. Electrochem. Soc.,</i> <b>144</b>,
    1208 (1997).</p>
    <p>12.&nbsp; E. Bayet, F. Huet, M. Keddam, K. Ogle, and H. Takenouti, <i>J.
    Electrochem. Soc.,</i> <b>144</b>(4),L87 (1997).</p>
    <p>13.&nbsp; H. S. Isaacs, Y. Ishikawa, <i>Corrosion 85</i>, paper 55, Nace
    International, Houston, TX (1985).</p>
    <p>14.&nbsp; R. S. Lillard, P.J. Moran and H.S. Isaacs, <i>J. Electrochem.
    Soc.,</i> <b>139</b>(4), 1007 (1992).</p>
    <p>15.&nbsp; A. M. Mierisch, S.R. Taylor, in <u>Electrochemically Based
    Microstructural Characterization</u>, Vol. 500, Ed. By R.A. Gerhardt, M.A.
    Alim, S.R. Taylor, Materials Rsearch Society, Warrendale, PA, p.35 (1998).</p>
    <p>16.&nbsp; M. W. Wittman and S.R. Taylor, in <u>Advances in Corrosion
    Protection by Organic Coatings II</u>, Ed. By J.D. Scantlebury and M.W.
    Kendig, The Electrochem. Soc., PV <b>95-13</b>:158-168 (1995).</p>
    <p>17.&nbsp; R.G. Buchheit, R.P. Grant, P.F. Hlava, B. Mckenzie, G.L. Zender,
    <i>J. Electrochem Soc.,</i> <b>144</b>(8):2621 (1997).</p>
    <p>18.&nbsp; J.A. Grandle, S.R. Taylor, <i>Corrosion</i>, <b>50</b>(10):792
    (1994).</p>
    <p>19.&nbsp; J.E. Castle, in <u>Advanced Monitoring and Analytical
    Techniques</u>, Ed. By F. Mansfeld, W.H. Smyrl, Proceeding of <i>Corrosion</i>,
    (1997).</p>
    <p>20.&nbsp; J. Zhao, G. Frankel, R.L. McCreery, <i>J. Electrochem. Soc</i>.,
    <b>145</b>(7):2258 (1998).</p>
    <p>21.&nbsp; G.P. Halada, C.R. Clayton, M.J. Vasquez, J.R. Kearns, M.W.
    Kendig, S.L. Jeanjaquet, G.G. Peterson, G.S. McCarthy, G.L. Carr, in <u>Critical
    Factors in Localized Corrosion III</u>, Electrochemical Society, PV98-17
    (1998).</p>
    <p>22.&nbsp; A.E. Hughes, R. Taylor, B. Hilton, <i>Surface and Interface
    Analysis</i>, <b>25</b>(4):223 (1997).</p>

...
<meta name="DC.Creator" scheme="OCEANName" content="personName=S.H. Zhang;organisationName=Corrosion and ProtectionCentre, UMIST;
address=P.O.Box 88, Manchester, M60 1QD, UK">
<meta name="DC.Contributor" scheme="OCEANName" content="personName=S.B. Lyon;organisationName=Corrosion and ProtectionCentre, UMIST;
...
<meta name="DC.Description" content="Samples of iron were exposed during 1993 in two batches; firstly over the
...
<meta name="DC.Date.created" content="1995-02-19">
<meta name="DC.Date.issued" content="1995-03-21">
<meta name="DC.Type" content="Text">
<meta name="DC.Format" content="text/html">
<meta name="DC.Format" content="9311 bytes">
...
<meta name="DC.Subject" scheme="OCEANDictionary-V00001" content="pitting; steel">
<meta name="DC.Subject" scheme="OCEANDictionary-V00001" content="passivity; iron; atmosphere">
<title>JCSE Volume 1, Paper 1</title>
<link rel="schema.DC" href="http://purl.org/dc"> 
<SCRIPT src="/getcomm.php?vol=1&pap=1"></SCRIPT>
<SCRIPT src="/jsinc/jcsesubs.js.php"></SCRIPT>
<SCRIPT>
getcommentmode();</SCRIPT>
<base href="http://www.jcse.org/volume1/paper1/v1p1.php">
</HEAD><body>
<script>var lgi=<?php if ($logged_in) { echo('true');} else { echo('false');} ?>;</script>
<script src="/jsinc/writeheader.js"></script><?php ggl_ad(); ?>

<h2>Volume 1 Paper 1</h2>
<script>ifnotmode(3,'<p>Submitted 19 February 1995, revised version published 21 March 1995</p>');</script>
<hr>
...
<SCRIPT>comment(3)</SCRIPT><p>The original aim of the atmospheric exposures described herein were to
...
<SCRIPT>comment(4)</SCRIPT><h4>EXPERIMENTAL METHOD</h4>
  ...
  hours at 25�C, the wires were then mounted in standard metallographic moulds
...
<SCRIPT>comment(5)</SCRIPT><p>An initial batch of ten samples was prepared and exposed for 4 months
...
<SCRIPT>comment(6)</SCRIPT><h4>OBSERVATIONS AND DISCUSSION</h4>
  ...
  expected.</p>
<SCRIPT>comment(7)</SCRIPT><p>This information is summarised below:</p>
    <hr>
    ...
    <hr>
<p>
<img src="http://www.jcse.org/volume1/paper1/p1-fig1.gif" align="bottom" width="243" height="186"> 
<SCRIPT>comment(8)</SCRIPT><br>Figure 1 and <br>
</SCRIPT>
<img src="http://www.jcse.org/volume1/paper1/p1-fig2.gif" align="bottom" width="236" height="194">
<SCRIPT>comment(9)</SCRIPT><br>Figure 2
...
<img src="http://www.jcse.org/volume1/paper1/p1-fig3.gif" align="bottom" width="236" height="194"> 
<SCRIPT>comment(11)</SCRIPT><br>Figure 3 shows the other bright sample at higher magnification. The bright samples all
...
<SCRIPT>comment(12)</SCRIPT><p>That bare, untreated iron remains largely uncorroded and passive for
...
<SCRIPT>comment(13)</SCRIPT><p>Whatever the reason, this observation is strong evidence that the corrosion
...
<SCRIPT>comment(14)</SCRIPT><h4>CONCLUDING REMARKS</h4>
...
<SCRIPT>comment(15)</SCRIPT><h4>REFERENCES</h4>
  <ol>

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('createComment') }}">
                            ...
                            <div class="form-group row">
                                <label for="commentText" class="col-md-4 col-form-label text-md-right">{{ __('Comment') }}</label>

                                <div class="col-md-6">
                                    <textarea rows="20" id="commentText" type="text" class="form-control{{ $errors->has('commentText') ? ' is-invalid' : '' }}" name="commentText" value="{{ old('commentText') }}" required autofocus>
                                        Enter comment here
                                    </textarea>

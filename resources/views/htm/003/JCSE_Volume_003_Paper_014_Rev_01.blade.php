<h2>JCSE Volume 3 Paper 14</h2>
  <p>Submitted 9th July 2001<br>
  <hr>
...
<p>&sect;2 Electrode potential is one of the fundamental notions of
...
<p>&sect;5 Muller [<script>crossref(1)</script>,<script>crossref(2)</script>] was the first who came up with an idea
...
<p align=center>&sect;6
<img border=0
src="{{ $htmURL }}v3p14_files/image002.gif" width="179" height="32"> (1)</p>
...
<p>&sect;7 Absolutely the same equation was advanced by Muller for a
...
<p><img border=0
src="{{ $htmURL }}../../volume3/paper14/v3p14f1.gif" width="785" height="287"></p>
...
<p>&sect;9 Fig. 1 was considered by Daniel-Bek as applied to a
...
<img border=0
src="{{ $htmURL }}v3p14_files/image006.gif" width="95" height="25"> (2)</p>

<p align=center>&sect;11 <sub>
<img border=0
src="{{ $htmURL }}v3p14_files/image008.gif" width="95" height="25"></sub>  (3)</p>

<p align="left">&sect;12 where E<sub>a</sub>, b<sub>a</sub> &#1080; E<sub>k</sub>, b<sub>k</sub>
...
<p align="center">&sect;13 &nbsp; <sub>
<img border=0
src="{{ $htmURL }}v3p14_files/image010.gif" width="151" height="29"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(4)</p>

<p>&sect;14 The equivalent electric circuit (Fig. 1(3)) was proposed by
...
<p>&sect;15 In the 1990-s Gerasimova [<script>crossref(6)</script>]
...
<p>&sect;16 It was the following scheme: </p>

<p align=center><img border=0
src="{{ $htmURL }}v3p14_files/image011.gif" width="179" height="104"></p>

<p>&sect;17 Figure 2. The Gerasimova equivalent circuit</p>
...
<p>&sect;18 The author got the following expression for the potential of
an electrode covered with a corrosion product film. This potential was measured
with a voltmeter: </p>

<p align=center><sub><img border=0
src="{{ $htmURL }}v3p14_files/image013.gif" width="120" height="55"></sub> (5)</p>

<p>where U<sub>V.</sub>- voltmeter reading</p>

<p align=center><sub><img border=0
src="{{ $htmURL }}v3p14_files/image015.gif" width="159" height="25"></sub>
(6)</p>

<p align=center><sub><img border=0
src="{{ $htmURL }}v3p14_files/image017.gif" width="152" height="25"></sub>
(7)</p>

<p>&sect;19 The obtained result shows that, if R<sub>i</sub>=0 then U<sub>V.</sub>=&#1045;1.
...
<p>&sect;20 The comparison of the approaches of Akimov, Tomashev,
...
<p>&sect;23 The difference consists in the fact that Gerasimova unlike Daniel-Bek:</p>
...
<p>&sect;26 The Daniel-Bek and Gerasimova equivalent circuits have some
...
<p>&sect;35 We can neglect the points (2a,
...
<p align="center"> <sub><img border=0
src="{{ $htmURL }}v3p14_files/image019.gif" width="84" height="37"></sub>
(8)</p>
...
<p align=center><img border=0
src="{{ $htmURL }}v3p14_files/image020.gif" width="127" height="77"></p>
...
<h4>&sect;44 The application of the proposed method to the
modeling of the corroding behavior of a metal in arbitrary corrosive
environment.</h4>

<p>&sect;45 Guided by these principles, the authors of this paper
propose
...
<p>&sect;46 The most simple equivalent electric circuit we propose is
the following:</p>

<p align=center><img border="0" src="{{ $htmURL }}../../volume3/paper14/v3p14f3.gif" width="441" height="227"></p>

<p align="center"><b>Figure 3. The equivalent
circuit proposed in this work.</b></p>

<p>&sect;47 After simplifying the circuit it is as shown in Fig.
4</p>

<p align=center><b><img border=0
src="{{ $htmURL }}v3p14_files/image022.gif" width="350" height="202"></b></p>

<p align="center">&sect;48 <b>Figure 4. The paper authors equivalent circuit after some
simplifications.</b></p>
...
<p>&sect;50 R<sup>S</sup><sub>c1</sub> and R<sup>S</sup><sub>a1</sub>
...
<p>&sect;51 R<sup>a</sup><sub>S</sub> and R<sup>k</sup><sub>S</sub>
...
<p align=center><sub><img border=0
src="{{ $htmURL }}v3p14_files/image024.gif" width="108" height="26"></sub><sub><img border=0
src="{{ $htmURL }}v3p14_files/image026.gif" width="93" height="25"></sub></p>

<p>&sect;52 R<sup>M</sup><sub>c</sub>
...
<p>&sect;53  E<sub>Me</sub><sub>/Me(+)</sub>
and E<sub>Red/Ox</sub>  emf
(potentials) values, corresponding to the following processes: </p>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image028.gif" width="133" height="27"></sub>
(9)</p>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image030.gif" width="188" height="27"></sub>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(10)</p>

<p>&sect;54 these values are calculated by means of the Gibbs equation
for change of energies of the corresponding processes. </p>

<p>&sect;55 E<sub>sc</sub> and E<sub>sa</sub> - the values of the emfs of solvation processes (cation and
...
<p>&sect;59 If you cant understand the nature of the R<sup>S</sup><sub>c</sub>,
R<sup>S</sup><sub>a</sub>, R<sup>M</sup><sub>c</sub> &#1080; R<sup>M</sup><sub>a</sub>
values see Appendix 2.</p>

<p>&sect;60 The calculation based on the second Kirchhoff's law for our
...
<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image032.gif" width="515" height="53"></sub>  (11)</p>
...
<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image034.gif" width="539" height="50"></sub> (12)</p>

<p>&sect;63 The total corrosion current (I<sub>cor</sub>) equal to the
sum of the I<sub>f.i.s.</sub> and I<sub>f.s.s.</sub>currents:</p>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image036.gif" width="564" height="50"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (13)</p>

<p>&sect;64 The expressions (11)-(13) we got have a clear thermodynamic meaning. </p>

<p>&sect;65 The (E<sub>cr.</sub>+E<sub>Red/Ox</sub>+
...
<p>&sect;66 (E<sub>sc</sub>+E<sub>sa</sub>+E<sup>S</sup><sub>inter.</sub>+E<sub>Red/Ox</sub>+
...
<p>&sect;67 It is obvious that both expressions (11) and (12) include
the same term, but with different signs:</p>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image038.gif" width="335" height="47"></sub>
(14)</p>

<p>&sect;68 This term is the electrical current analogue of the rate of
the physical dissolving of a film. </p>

<p>&sect;69 The I<sub>&#1082;</sub> value of the total metal corrosion
...
<p>&sect;70 The extreme cases of the functioning of the equivalent circuit
are the following:</p>

<h4>&sect;71 I - The Sum of the Resistances of the Migration of Ions on the Surface of a
Film is Much&nbsp; Larger than the Sum of the Ionic Resistances of the Solution.</h4>

<p align="center">&nbsp; <sub><img border=0
src="{{ $htmURL }}v3p14_files/image040.gif" width="168" height="25"></sub></p>

<p>&sect;72 In the case, total corrosion current is equal to:</p>

<p align=center><sub><img border=0
src="{{ $htmURL }}v3p14_files/image042.gif" width="347" height="61"></sub> (15)</p>

<p>&sect;73 So, when the sum of the resistances of the migration of ions
...
<h4>&sect;74 II - The Sum of the Ionic Resistances of the
Solution is Much&nbsp; Greater than the Sum of the Resistances of the Migration
of Ions on the Surface of a Film.</h4>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image044.gif" width="167" height="25"></sub></p>

<p>&sect;75 In this case the current, is given by:</p>

<p align=center><sub><img border=0
src="{{ $htmURL }}v3p14_files/image046.gif" width="240" height="50"></sub>  (16)</p>
...
<p>&sect;76 An example of this kind of corrosion is metal corrosion in
...
<p>&sect;77 These two extreme cases show that
...
<p>&sect;78 The following consequences,
...
<p>&sect;80 The authors of this paper believe that this method of modeling can easily be applied to interpreting
...
<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image048.gif" width="467" height="51"></sub>   (17)</p>
...
<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image050.gif" width="431" height="46"></sub>   (18)</p>
...
<p align=center><sub><img border=0
src="{{ $htmURL }}v3p14_files/image052.gif" width="336" height="51"></sub>
(19)</p>
...
<p align=center><sub><img border=0
src="{{ $htmURL }}v3p14_files/image054.gif" width="131" height="43"></sub> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(20)</p>
...
<p align="center"> <sub><img border=0
src="{{ $htmURL }}v3p14_files/image056.gif" width="145" height="41"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(21)</p>
...
<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image058.gif" width="359" height="55"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(22)</p>

<p>where </p>

<p> <sub><img border=0
src="{{ $htmURL }}v3p14_files/image060.gif" width="120" height="47"></sub>
(23)</p>
...
<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image062.gif" width="255" height="54"></sub> (24)</p>
...
<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image064.gif" width="662" height="43"></sub></p>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image066.gif" width="623" height="62"></sub> (25)</p>
...
<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image068.gif" width="603" height="40"></sub>(26)</p>
...
<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image070.gif" width="592" height="47"></sub> &nbsp;&nbsp;(27)</p>
...
<p align="center"> <sub><img border=0
src="{{ $htmURL }}v3p14_files/image072.gif" width="286" height="55"></sub>&nbsp;&nbsp;(28)</p>
...
<p align="center"> <sub><img border=0
src="{{ $htmURL }}v3p14_files/image074.gif" width="289" height="55"></sub>&nbsp;&nbsp;(29)</p>
...
<p align="center"> <sub><img border=0
src="{{ $htmURL }}v3p14_files/image076.gif" width="406" height="58"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(30)</p>

<p>where:</p>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image078.gif" width="156" height="23"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(31)</p>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image080.gif" width="84" height="22"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(32)</p>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image082.gif" width="84" height="20"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(33)</p>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image084.gif" width="216" height="25"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(34)</p>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image086.gif" width="192" height="25"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(35)</p>

<p align="center"><sub><img border=0
src="{{ $htmURL }}v3p14_files/image088.gif" width="288" height="27"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(36)</p>
...
<table border=1 cellspacing=0 cellpadding=0>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image090.gif" width="566" height="47"></sub></p>
  </td>
 </tr>
 <tr>
  <td width=666 valign=top>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image092.gif" width="540" height="47"></sub></p>
  </td>
 </tr>
 <tr>
  <td width=666 valign=top>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image094.gif" width="540" height="48"></sub></p>
  </td>
 </tr>
 <tr>
  <td width=666 valign=top>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image096.gif" width="578" height="47"></sub></p>
  </td>
 </tr>
 <tr>
  <td width=666 valign=top>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image098.gif" width="581" height="48"></sub></p>
  </td>
 </tr>
 <tr>
  <td width=666 valign=top>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image100.gif" width="555" height="47"></sub></p>
  </td>
 </tr>
</table>
...
<table border=1 cellspacing=0 cellpadding=0>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image102.gif" width="579" height="49"></sub></p>
  </td>
 </tr>
 <tr>
  <td width=666 valign=top>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image104.gif" width="573" height="50"></sub></p>
  </td>
 </tr>
 <tr>
  <td width=666 valign=top>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image106.gif" width="573" height="52"></sub></p>
  </td>
 </tr>
 <tr>
  <td width=666 valign=top>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image108.gif" width="577" height="47"></sub></p>
  </td>
 </tr>
 <tr>
  <td width=666 valign=top>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image110.gif" width="581" height="48"></sub></p>
  </td>
 </tr>
 <tr>
  <td width=666 valign=top>
 ...
 <tr>
  <td width=666 valign=top>
  <p><sub><img border=0
  src="{{ $htmURL }}v3p14_files/image112.gif" width="553" height="45"></sub></p>
  </td>
 </tr>
</table>

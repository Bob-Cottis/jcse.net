<h2>JCSE Volume 3 Paper 22</h2>
  <p>Submitted 14th August 2002, revised version submitted 28th November 2002<br>
  <hr>
...
<p>&sect;1 <b>Keywords</b>:
galvanic element, modelling.</p>

<h3>Introduction</h3>

<p>&sect;1 The detailed studies of corrosion processes, which take
...
<p>&sect;1 Obviously, it is impossible to find an approach to the
...
<p>&sect;1 In our opinion, the well thought-out equivalent electric
...
<p>&sect;1 In the previous paper [1], the principles of the building of
...
<p>&sect;1 In this paper we tried to use the approach for the concrete
...
<p>&sect;1 All above-enumerated values are the functions of the
...
<p>&sect;1 The author of the paper realizes that a number of models of
...
<p>&sect;1 The model of the functioning of a galvanic element, proposed by the
author of the paper.</p>

<p>&sect;1 As a sample of modelling of a galvanic element functioning,
...
<p>&sect;1 Guided by the aforesaid assumptions the author of the paper
proposes the following equivalent electric circuit to describe this model of a
galvanic element:</p>

<p align="center">&sect;1
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image001.gif" width="589" height="262"></p>

<p>&sect;1 <b>Fig. 1. the equivalent electric circuit proposed by the
...
<p>&sect;1 RM11, RM12 - the Ohmic resistances of the metal of the anode
...
<p>&sect;1 RM21, RM22 - the values that are similar to RM11 and RM12,
but for cathode (M2)</p>

<p>&sect;1 Rc1, Rc2 - respectively, the sums of the cationic
...
<p>&sect;1 Re1, Re2 - respectively, the sums of the
...
<p>&sect;1 Rs1ox, Rs2ox - respectively, the resistance of
the transferring of the molecules (ions) of an oxidant to the film surface for
anode and cathode.</p>

<p>&sect;1 Ras2 and Ras1 - the
...
<p>&sect;1 Rcs3 and Rcs4 - the resistance of the transferring of the
...
<p>&sect;1 Rciajaj, Rciajci - the anionic and cationic resistance of
...
<p>&sect;1 Rcjsaisais, Rcjsaiscjs, Rscjsais, Rsaiscjs - the anionic and
...
<p>&sect;1 Rext - the external pure resistance</p>

<p>&sect;1 &#1045;&#1084;1, &#1045;&#1084;2 - the emf, corresponding to the direct reactions of
the processes: M1<sup>&nbsp; </sup>&rarr; c1 + e (for anode) and M2<sup>&nbsp; </sup>&rarr;c2 + e (for cathode).</p>

<p>&sect;1 ER1, ER2 - the emf, corresponding to the direct reactions of
the processes: Ox + &#1077; &rarr; a1 (for anode)
and Ox + &#1077; &rarr; a2 (for cathode).</p>

<p>&sect;1 Efcc2a2, Efac1a1- the emf, corresponding to the direct
reactions of the processes: c2 + &#1072;2 &rarr;
c2a2 (on the cathode) and c1 + &#1072;1 &rarr; c1a1
(on the anode). </p>

<p>&sect;1 Esci, Esai - the emf, corresponding to the direct reactions
of the processes of the solvation of cation ci and anion ai (i=1 for anode and
i=2 for cathode).</p>

<p>&sect;1 Escisajs - the emf, corresponding to the direct reaction of
the process of the formation of a neutral substance cisajs (in the solution)
from solvated ions cis and ajs (i=1&cedil;2;
j=1&cedil;2)</p>

<p>&sect;1 Ep - the emf (or voltage) of an external source of emf
(voltage).</p>

<p>&sect;1 Each circuit of the equivalent electric circuit describes
...
<p>&sect;1 <b>Table 1. the list of some circuits of the total circuit
...
<table border=1 cellspacing=0 cellpadding=2 style="border-collapse: collapse" bordercolor="#111111">
 <tr>
  <td valign=top>
  <p>&sect;1 Circuit nodes</p>
  </td>
  <td valign=top>
  <p>&sect;1 algebraic sum of the emf vectors of this circuit</p>
  </td>
  <td valign=top>
  <p>&sect;1 The description of the chemical processes taking place in
  this circuit</p>
  <p>&sect;1 &nbsp;</p>
  </td>
 </tr>
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 ER1 + Ef&#1072;c1&#1072;1 + &#1045;&#1052;1</p>
  </td>
  <td valign=top>
  <p>&sect;1 A cation (c1) and electron are generated on the metal/film
  ...
  <p>&sect;1 The obtained delocalized cation (c1) and anion (a1)
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 ER2 + Efcc2&#1072;2 + &#1045;&#1052;2</p>
  </td>
  <td valign=top>
  <p>&sect;1 A cation (c2) and electron are generated on the metal/film
...
<p>&sect;1 The author of the paper assumes that the positive circuit
...
<p>&sect;1 The calculation of the equivalent circuit was made after
some insignificant simplification shown below:</p>

<p align="center">&sect;1
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image002.gif" alt="The figure shows the equivalent circuit obtained from the initial circuit by means of some insignificant simplifications. Some of the resistances of this circuit are the sums of the initial circuit resistances that were connected in series. This equivalent circuit contains the same nodes as the initial circuit." width="413" height="216"></p>

<p>&sect;1 <b>Fig.2. The result of the simplification of the authors initial
...
<table border=0 cellspacing=0 cellpadding=0>
 <tr>
  ...
  <p>&sect;1 R1 = RM12 + Rc1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
  <SCRIPT>comment(1)</SCRIPT>
  <p>&sect;1 R3 = RM11 + Re1 + Rs1Ox&nbsp;&nbsp;&nbsp;&nbsp; </p>
  <SCRIPT>comment(1)</SCRIPT>
  <p>&sect;1 R5 = Rsa1sc2s + Rsc2sa1s</p>
  ...
  <p>&sect;1 R11 = Rcs4</p>
  <p>R13 = Rext</p>
  <p>&sect;1 R15=Rc2sa2sa2s + Rc2sa2sc2s</p>
  <p>E2 = Efac1a1 </p>
  <p>&sect;1 E4 = Esa1</p>
  <p>&sect;1 E6 = Esc1sa1s</p>
  <p>&sect;1 E8 = Efcc2a2</p>
  <p>&sect;1 E10 = Esa2</p>
  <p>&sect;1 E12 = Esc2sa2s</p>
  <p>&sect;1 E14 = Esc1sa2s</p>
  <p>&sect;1 &nbsp;</p>
  </td>
  <td width=336 valign=top>
  <p>&sect;1 R2 = Rc1a1c1 + Rc1a1a1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;</p>
  <p>R4 = Rsc1sa2s + Rsa2sc1s&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p>
  <p>R6 = Rc2a2a2 + Rc2a2c2</p>
  <p>&sect;1 R8 = Rc2 + RM22</p>
  <p>&sect;1 R10 =
  Ras2&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;</p>
  <p>R12 = Rcs3</p>
  <p>&sect;1 R14=Rc1sa1sa1s + Rc1sa1sc1s&nbsp;&nbsp; &nbsp;</p>
  <p>E1 =
  ER1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;</p>
  <p>&sect;1 E3 = EM1<sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<p>&sect;1 <sub>&nbsp;</sub>The following currents were calculated for
this circuit:</p>
...
<p>&sect;1 The calculation of the currents in this equivalent electric circuit
was made on the basis of the second Kirchhoff's law for these 6 aforesaid
circuits. </p>

<h4>&sect;1 The results of the calculation of parameters of the proposed
equivalent circuit.</h4>

<p>&sect;1 It was found: </p>
...
<blockquote>
  ...
  <img src="{{ $htmURL }}v3p22.1.gif" v:shapes="_x0000_i1025" align="bottom" alt="J sub i is equal to the sum for j=1 to m&nbsp; of  J1j" width="77" height="48">,</span>&nbsp;where
  ...
  <span style="position: relative; top: 15.0pt">
  <img src="{{ $htmURL }}v3p22.2.gif" v:shapes="_x0000_i1026" align="bottom" alt="Jj is equal to K1j divided by K times the sum for f=1 to m of Ef" width="95" height="48">,  </span>where <span style="position: relative; top: 15.0pt">
  <img src="{{ $htmURL }}v3p22.3.gif" v:shapes="_x0000_i1027" align="bottom" width="44" height="48"></span> is the
...
<p align=center><sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image003.gif" alt="J subscript i is equal to 1 divided by K times the sum for j=1 to n of (K1 subscript j times the sum for f=1 to m of (E subscript f)))" align="middle" width="153" height="48"></span></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(1)</p>
...
<p>&sect;1 The list of the 47 subcircuits that exert influence upon all
electric currents, calculated in this paper, is shown in Table 2.</p>

<p>&sect;1 <b>Table 2. The list of 47 subcircuits that exert influence
...
<table border=1 cellspacing=0 cellpadding=0 bordercolor="#993333" style="border-collapse: collapse">
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 i-subcircuit</p>
  </td>
  <td valign=top>
  <p>&sect;1 K1i value of this subcircuit</p>
  </td>
 </tr>
 <tr>
  <td colspan=3 valign=top>
  <p>&sect;1 Circuits that do not contain the source of the external
  polarization (E15)</p>
  </td>
 </tr>
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 R13 &times; [[(R4 &times; R10 + R4 &times; R14 + R10
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 R13 &times; [[(R1 &times; R10 + R1 &times; R2 + R2 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E2 - E4 - E5 - E6)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R1 + R3) &times; [[(R4 &times; R11 + R4 &times; R15 + R11
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E8 - E10 - E11 - E12)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R7 + R8) &times; [[(R2 &times; R9 + R2 &times; R3 + R3
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E6 + E13 + E14 - E12)</p>
  </td>
  <td valign=top>
  <p>&sect;1 [(R1 &times; R10 + R1 &times; R2 + R2 &times; R10) + (R2
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E1 + E3 + E4 + E5 + E6)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R2 &times; [[(R4 &times; R11 + R4 &times; R15 + R11
  &times; R15) + (R5 &times; R12 + R5 &times; R15 + R12 &times; R15) + (R4
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E12 + E10 + E11 + E7 + E9)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R6 &times; [[(R4 &times; R10 + R4 &times; R14 + R10
  &times; R14) + (R5 &times; R9 + R5 &times; R14 + R9 &times; R14) + (R4
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E6 + E13 + E14 + E10 + E11 - E8)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R15 &times; [[(R1 &times; R10 + R1 &times; R2 + R2 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E2 + E4 + E5 + E13 + E14 - E12)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R14 &times; [[(R6 &times; R11 + R6 &times; R7 + R7 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E6 + E13 + E14 + E10 + E11 + E7 + E9)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R15 &times; R6 &times; [R13 &times; [(R1 &times; R10 + R1
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E1 + E3 + E4 + E5 + E13 + E14 - E12)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R2 &times; R14 &times; [R13 &times; [(R6 &times; R11 + R6
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E1 + E3 + E4 + E5 + E13 + E14 + E10 + E11 + E7 + E9)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R2 &times; R14 &times; R15 &times; R6 &times; R13</p>
  </td>
 </tr>
 <tr>
  <td valign=top>
  ...
  <td valign=top>
  <p>&sect;1 (-E2 + E4 + E5 + E13 + E14 + E10 + E11 - E8)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R14 &times; R15 &times; [(R7 &times; R13 + R7 &times; R8 +
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E2 + E4 + E5 + E13 + E14 + E10 + E11 + E7 + E9)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R14 &times; R15 &times; R6 &times; (R1 &times; R13 + R1
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E1 + E3 + E4 + E5 + E13 + E14 + E10 + E11 - E8)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R2 &times; R14 &times; R15 &times; (R7 &times; R13 + R7
  &times; R8 + R8 &times; R13)</p>
  </td>
 </tr>
 <tr>
  <td colspan=3 valign=top>
  <p>&sect;1 Circuits containing the source of the external
  polarization (E15)</p>
  </td>
 </tr>
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E4 - E13 - E11 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 [(R1 &times; R10 + R1 &times; R2 + R2 &times; R10) &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E5 + E14 + E10 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 [(R2 &times; R9 + R2 &times; R3 + R3 &times; R9) &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E2 + E5 + E14 + E10 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R1 &times; [(R5 &times; R9 + R5 &times; R14 + R9 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E2 - E4 - E13 - E11 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R3 &times; [(R4 &times; R10 + R4 &times; R14 + R10 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E5 + E14 + E10 - E8 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R7 &times; [(R2 &times; R9 + R2 &times; R3 + R3 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E4 - E13 - E11 + E8 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R8 &times; [(R1 &times; R10 + R1 &times; R2 + R2 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E4 - E6 + E14 + E10 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R1 &times; R10 + R1 &times; R2 + R2 &times; R10) &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E5 + E6 - E13 - E11 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R2 &times; R9 + R2 &times; R3 + R3 &times; R9) &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E5 + E14 - E12 - E11 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R6 &times; R11 + R6 &times; R7 + R7 &times; R11) &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E4 - E13 + E12 + E10 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R6 &times; R12 + R6 &times; R8 + R8 &times; R12) &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E2 + E5 + E6 - E13 - E11 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R1 &times; R9 &times; [(R6 &times; R11 + R6 &times; R7 +
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E2 - E4 - E6 + E14 + E10 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R3 &times; R10 &times; [(R6 &times; R12 + R6 &times; R8 +
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E2 + E5 + E14 + E10 - E8 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R1 &times; R7 &times; [(R5 &times; R9 + R5 &times; R14 +
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E2 - E4 - E13 - E11 + E8 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R3 &times; R8 &times; [(R4 &times; R10 + R4 &times; R14 +
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E4 - E13 + E12 + E10 - E8 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R7 &times; R12 &times; [(R1 &times; R10 + R1 &times; R2 +
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E5 + E14 - E12 - E11 + E8 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R8 &times; R11 &times; [(R2 &times; R9 + R2 &times; R3 +
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E2 + E5 + E14 - E12 - E11 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R1 &times; (R5 &times; R9 + R5 &times; R14 + R9 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E2 + E5 + E14 - E12 - E11 + E8 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R1 &times; (R5 &times; R9 + R5 &times; R14 + R9 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E2 + E5 + E6 - E13 + E12 + E10 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R1 &times; R9 &times; R4 &times; (R6 &times; R12 + R6
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E2 + E5 + E6 - E13 - E11 + E8 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R1 &times; R9 &times; (R4 &times; R11 + R4 &times; R15 +
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E4 - E6 + E14 - E12 - E11 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R1 &times; R10 + R1 &times; R2 + R2 &times; R10) &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E4 - E6 + E14 - E12 - E11 + E8 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R1 &times; R10 + R1 &times; R2 + R2 &times; R10) &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E4 - E6 + E14 + E10 - E8 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R1 &times; R10 + R1 &times; R2 + R2 &times; R10) &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E2 - E4 - E13 + E12 + E10 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R3 &times; (R4 &times; R10 + R4 &times; R14 + R10 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E2 - E4 - E6 + E14 - E12 - E11 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R3 &times; R10 &times; R5 &times; (R6 &times; R11 + R6
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E2 - E4 - E13 + E12 + E10 - E8 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R3 &times; (R4 &times; R10 + R4 &times; R14 + R10 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E2 - E4 - E6 + E14 + E10 - E8 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R3 &times; (R5 &times; R12 + R5 &times; R15 + R12 &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E5 + E6 - E13 + E12 + E10 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R2 &times; R9 + R2 &times; R3 + R3 &times; R9) &times; R4
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E5 + E6 - E13 - E11 + E8 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R2 &times; R9 + R2 &times; R3 + R3 &times; R9) &times;
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E5 + E6 - E13 + E12 + E10 - E8 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 (R2 &times; R9 + R2 &times; R3 + R3 &times; R9) &times; R4
 ...
 <tr>
  ...
  <td valign=top>
  <p>&sect;1 (-E1 - E2 + E5 + E6 - E13 + E12 + E10 - E8 - E9 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R1 &times; R9 &times; R4 &times; R12 &times; R7</p>
  </td>
 </tr>
 <tr>
  <td valign=top>
  ...
  <td valign=top>
  <p>&sect;1 (E3 + E2 - E4 - E6 + E14 - E12 - E11 + E8 + E7 + E15)</p>
  </td>
  <td valign=top>
  <p>&sect;1 R3 &times; R10 &times; R5 &times; R11 &times; R8</p>
  </td>
 </tr>
</table>

<p>&sect;1 The analysis of the obtained expressions shows:</p>
...
<p>&sect;1 <b>Note</b>: It is necessary to take into consideration that
...
<h4>&sect;1 The working current (or the measured current) of a galvanic element
(J6).</h4>

<p>&sect;1 It was found, that the current J6 depends on the overall
...
<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image004.gif" alt="J subscript 6 is equal to 1 divided by K times the sum for i=1 to 32 of (K1i times the (sum for j=1 to m of (Ej)))" align="middle" width="153" height="48"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(2)</p>
...
<p>&sect;1 The signs of the aforesaid sums must guarantee the positive
sign of the vector of E15.</p>

<p>&sect;1 It is important to draw your attention to the fact that, the
...
<h4>&sect;1 The emf of a galvanic element (emfel).</h4>

<p>&sect;1 On the basis of the expression for the working current of a
galvanic element it is easy to determine the expression for the emf of the
element. </p>

<p>&sect;1 In practice the emf of a power source is determined with the
...
<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image005.gif" alt="the emf of this element is equal to the (sum for i=1 to 32 of (the product of K1i &times; (E15 - sum for j=1 to m of (Ej)))) divided by Kemf" align="middle" width="279" height="48"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(3)</p>

<SCRIPT>comment(1)</SCRIPT>

<p>&sect;1 The equation for Kemf is given in  Appendix 1. </p>

<p>&sect;1 The value (E15 - sum (for j=1 to m of (Ej))) is similar to
...
<p>&sect;1 Since the equation (3) contains the subcircuits, which can
...
<p>&sect;1 The currents flowing through the system containing
...
<p>&sect;1 The equation for KJ6Ria is given in Appendix 1.</p>

<p>&sect;1 J6Ric={2 &times; E15 &times; (((R6 &times; R11 + R6 &times;
...
<p>&sect;1 The equation for KJ6Ric is given in Appendix 1.</p>

<p>&sect;1 The J6Ria current corresponds to the case, when E1=E7,
...
<h4>&sect;1 The internal resistance of a galvanic element (Rint).</h4>

<p>&sect;1 The expression for the internal resistance of a galvanic
...
<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image006.gif" align="middle" width="209" height="47"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(6)</p>

<p>&sect;1 Rint={[(R6 &times; R11 + R6 &times; R7 + R7 &times; R11) +
...
<p>&sect;1 One can say with confidence, that this expression is the
...
<h4>&sect;1 The currents of the formation of insoluble corrosion products on
the anode (J1) and cathode (J3).</h4>

<p>&sect;1 The expressions for corrosion currents J1 (for anode) and J3
(for cathode) are symmetrical (they are mirror images for each other), because
this circuit is symmetrical:</p>

<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image007.gif" alt="J1 is equal to 1 divided by K times the sum for i=1 to 21 of (K1i times the sum for j=1 to m of (Ej))" align="middle" width="153" height="48"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(8)</p>

<p>&sect;1 <strong style="font-weight: 400">where</strong> the sum for j=1 to m of (Ej) is equal
to the emf of the process, contained in the Table 2, which includes the value
of E2.</p>

<p align="center">&sect;1 <strong>&nbsp;</strong><sub><img
border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image008.gif" ALT="J3 is equal to 1 divided by K times the sum for i=1
to 21 of (K1i times the sum for j=1 to m of (Ej))" align="middle" width="153" height="48"></span></sub><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b>&nbsp;(9)</p>

<p>&sect;1 where the sum for j=1 to m of (Ej) is equal to the emf of
the process, contained in the Table 2, which includes the value of E8. </p>

<p>&sect;1 The signs of the aforesaid sums must guarantee the positive sign
of the vectors of E2 (in the case of J1) and E8 (in the case of J3).</p>

<p>&sect;1 The equations (8 and 9) show that the currents J1 and J3
...
<p>&sect;1 1.1.3.3.&nbsp; In the case of
...
<p>&sect;1 1.1.3.4.&nbsp; in the case of
...
<p>&sect;1 <strong>4.</strong><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>the
...
<p>&sect;1 The expressions of the values of these emfs are symmetrical
...
<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image009.gif" alt="if E15 equal to one divided by Ke1 times the sum for i=1 to 21 of (K1i times (E15 - the sum for j=1 to m of (Ej))) then the current J1 is equal to 0. Let call the value of E15 as E15J1" align="middle" width="255" height="48"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;(10)</p>

<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image010.gif" alt="if E15 equal to one divided by Ke3 times the sum for i=1 to 21 of (K1i times (E15 - the sum for j=1 to m of (Ej))) then the current J3 is equal to 0. Let call the value of E15 as E15J3" align="middle" width="256" height="48"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(11)</p>
...
<p>&sect;1 The equations for Ke1 and Ke3 are given in Appendix 1.</p>

<p>&sect;1 These results represent the values of the external
...
<p>&sect;1 The currents (J2 and J4), which form the anode's (cathode's)
soluble corrosion products in the solution.</p>

<p>&sect;1 <strong style="font-weight: 400">The expressions for corrosion currents J2 (for anode) and
J4 (for cathode) are symmetrical (they are mirror images for each other),
because this circuit is symmetrical. &nbsp;</strong></p>

<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image011.gif" alt="J2 is equal to one divided by K times the sum for i=1 to 21 of (K1i times the sum for j=1 to m of (Ej))" align="middle" width="156" height="48"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(12)</p>
...
<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image012.gif" alt="J4 is equal to one divided by K times the sum for i=1 to 21 of (K1i times the sum for j=1 to m of (Ej))" align="middle" width="156" height="48"></sub><strong>&nbsp;&nbsp;&nbsp;&nbsp; </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;(13)</p>
...
1.&nbsp;&nbsp;&nbsp; the soluble products of corrosion of the anode (cathode)
     form due to the currents:<p>&sect;1
...
<p>&sect;1 1.1.4.1.&nbsp;&nbsp;&nbsp;the compounds c1sa2s and c2sa1s dissociate in the solution;</p>

<p>&sect;1 1.1.4.2.&nbsp;&nbsp;&nbsp;in the case of the current J2, the formed ions c1s and a1s form a
...
<p>&sect;1 1.1.4.3.&nbsp;&nbsp;&nbsp;in the case of the current J2, the formed ions c2s and a2s desolvate. In
the case of the current J4, the formed ions c1s and a1s desolvate.</p>

<p>&sect;1 1.1.4.4.&nbsp;&nbsp;&nbsp;in the case of the current J2, the corrosion product film grows on the
...
<p>&sect;1 1.1.5.1.&nbsp;&nbsp;&nbsp;the compounds c1sa2s and c2sa1s dissociate in the solution;</p>

<p>&sect;1 1.1.5.2.&nbsp;&nbsp;&nbsp;in the case of the current J2, formed ions c2s and a2s are desolvated
...
<p>&sect;1 1.1.5.3.&nbsp;&nbsp;&nbsp;in the case of the current J2, the desolvated ion c2 transferred through
...
<p>&sect;1 1.1.5.4.&nbsp;&nbsp;&nbsp;in the case of the current J2, the compound c1sa1s forms in the
...
<p>&sect;1 The values of an external polarization emfs when J2 is equal to 0
(E<sub>15J2=0</sub>) and J4 is equal to 0 (E<sub>15J4=0</sub>).</p>

<p>&sect;1 The expressions of these values are
<strong style="font-weight: 400">mirror images for
each other, because this circuit is symmetrical.</strong></p>

<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image013.gif" alt="if E15 equal to one divided by Ke2 times the sum for i=1 to 21 of (K1i times (E15 - the sum for j=1 to m of (Ej))) then the current J2 is equal to 0. Let call the value of E15 as E15J2" align="middle" width="261" height="48"></sub>&nbsp;&nbsp;
&nbsp;(14)</p>

<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image014.gif" alt="if E15 equal to one divided by Ke4 times the sum for i=1 to 21 of (K1i times (E15 - the sum for j=1 to m of (Ej))) then the current J4 is equal to 0. Let call the value of E15 as E15J4" align="middle" width="260" height="48"></sub>&nbsp;&nbsp;
&nbsp;(15)</p>

<p>&sect;1 <strong style="font-weight: 400"> where the </strong>sum for j=1 to m of (Ej) - the
sum of the items of the emfel, whose emfs (emf<sub>i</sub>) of processes
include values of E6 or E12. </p>

<p>&sect;1 The signs of the
aforesaid sums must guarantee the negative sign of the vectors of E6 (in the
case of E15J3) and E12 </p>

<p>&sect;1 The equations for Ke2 and Ke4 are given in Appendix 1.</p>

<h4>&sect;1 The summed currents of corrosion of the anode (Ja = J1 + J2) and
the cathode (Jc = J3 + J4).</h4>

<p>&sect;1 The expressions of the values of the summed currents of
corrosion Ja and Jc are symmetrical (they are mirror images for each other)
because this circuit is symmetrical.</p>

<p align="center">&sect;1 Ja=J1 +
J3&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(16)</p>

<p align="center">&sect;1 Jc=J2 +
J4&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(17)</p>

<p>&sect;1 The results obtained show that:</p>
...
<p>&sect;1 The values of an external polarization (E15) when current Ja= J1 +
J2 =0 (E15J120) and Jc=J3 + J4=0 (E15J340).</p>

<p>&sect;1 The expressions of these values (E15J120 and E15J340) are
<strong style="font-weight: 400">mirror images for
each other, because the circuit is symmetrical. </strong></p>

<p align="center">&sect;1 <strong style="font-weight: 400">
E15J120=</strong> <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image015.gif" alt="if E15 is equal to one divided by Ke12 times the sum for i=1 to 24 of (K1i times (E15 - the sum for j=1 to m of (Ej)) then Ja=J1+J2=0. Let call this value of E15 as E15J120" align="middle" width="183" height="48"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(18)</p>

<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image016.gif" alt="if E15 is equal to one divided by Ke34 times the sum for i=1 to 24 of (K1i times (E15 - the sum for j=1 to m of (Ej)) then Jc=J3+J4=0. Let call this value of E15 as E15J340" align="middle" width="287" height="48"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(19)</p>

<p>&sect;1 where <sub>
<img
border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image017.gif" align="middle" alt="Sum for j=1 to m of Ej" width="39" height="47"></sub>&nbsp;is the
...
<p>&sect;1 The equations for Ke12 and Ke34 are given in Appendix 1.</p>

<p>&sect;1 The results obtained show that it is possible to stop
...
<h4>&sect;1 The current of the joint corrosion of the anode and cathode (Jjc).</h4>

<p>&sect;1 This type of corrosion is the result of the interaction, in
...
<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image018.gif" alt="Jjc is equal to one divided by K times the sum for i=1 to 25 of (K1i times the sum for j=1 to m of (Ej))" align="middle" width="172" height="48"></sub><strong>&nbsp;&nbsp; </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;(20)</p>

<p>&sect;1 where sum for j=1 to m of
...
<p>&sect;1 The result obtained shows that:</p>
...
<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image019.gif" alt="if E15 &nbsp;is equal to one divided by Kejc times the sum for i=1 to 25 of (K1i times (-E15 + the sum for j=1 to m of (Ej))  then the current Jjc are equal to 0. Let call this E15 value as (E15Jjc)." align="middle" width="281" height="48"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(21)</p>

<p>&sect;1 where sum for j=1 to m of (Ej) - the sum of
the items of the emfel, whose emfs (emf<sub>i</sub>) of processes include value
of E13. </p>

<p>&sect;1 The sign of the sum
must guarantee the positive sign of the vectors of E13.</p>

<p>&sect;1 The equation for Kejc is given in Appendix 1.</p>

<h4>The current of the total corrosion in a galvanic element Jcel=J1 + J2 + J3
+ J4 + Jjc</h4>

<p align="center">&sect;1 Jcel=J1 + J2 + J3 + J4 +
Jjc&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(22)</p>

<p>&sect;1 The result obtained shows that:</p>

<p>&sect;1 1.&nbsp; the total corrosion of the anode and cathode takes place due to
...
<p align="center">&sect;1 <sub>
<img border=0
src="{{ $htmURL }}http://www.jcse.org/volume3/paper22/v3p22_files/image020.gif" alt="if E15 is equal to one divided by Ke12345 times the sum for i=1 to 28 of (K1i times (E15 - the sum for j=1 to m of (Ej)) then the current Jcel is equal to 0. Let call this value of E15 as E15Jcel0" align="middle" width="311" height="48"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(23)</p>

<p>&sect;1 where: the sign of the sum must guarantee the
counter-clockwise direction of the vectors of E2, E6, E8, E12, E13.</p>

<p>&sect;1 The equation for Ke12345 is given in Appendix 1.</p>

<p>&sect;1 The result obtained shows that for this model there is such
...
<h3>&sect;1 Acknowledgments</h3>

<p>&sect;1 Special thanks to
...
<h4>&sect;1 Values of some terms</h4>

<p>The value of some of the terms used in the text are given by the following
expressions:</p>

<p>&sect;1 K={[(R6 &times; R11 + R6 &times; R7 + R7 &times; R11) + (R6
&times; R12 + R6 &times; R8 + R8 &times; R12) + (R7 &times; R12 + R8 &times;
...
<p>&sect;1 Kemf={[(R1 &times; R10 + R1 &times; R2 + R2 &times; R10) +
...
<p>&sect;1 KJ6Ria={[(R1 &times; R10 + R1 &times; R2 + R2 &times; R10) +
...
<p>&sect;1 KJ6Ric={[(R6 × R11 + R6 × R7 + R7 × R11) + (R6 ×
...
<p>&sect;1 Ke1={[(R6 &times; R11 + R6 &times;
R7 + R7 &times; R11) + (R6 &times; R12 + R6 &times; R8 + R8 &times; R12) + (R7
...
<p>&sect;1 Ke3={[(R1 × R10 + R1 × R2 + R2 × R10) + (R2 × R9 +
...
<p>&sect;1 Ke34={ [(R1 × R10 + R1 × R2 + R2 × R10) + (R2 × R9
...
<p>&sect;1 The figure shows the initial equivalent circuit
used in this paper. There are following major nodes in the circuit:</p>

<p>&sect;1 node 0 corresponds to the bulk of the metal of the anode</p>

<p>&sect;1 node 1 corresponds to the place on the anode film where
delocalized anion (a1) is generated</p>

<p>&sect;1 node 2 corresponds to the place, on the anode, where the
delocalized cation (c1) of the anode metal goes out on the film surface on the
anode</p>

<p>&sect;1 node 3 corresponds to the place, in the solution, where
solvated anion (a1s) is generated</p>

<p>&sect;1 node 4 corresponds to the place, in the solution, where
solvated cation (c1s) of the anode metal is formed</p>

<p>&sect;1 node 5 correspond to the place, in the solution, where
solvated cation (c2s) of the cathode metal is formed</p>

<p>&sect;1 node 6 corresponds to the place, in the solution, where
solvated anion (a2s) is generated</p>

<p>&sect;1 node 7 corresponds to the place, on the cathode, where the delocalized cation (c2) of the cathode metal goes
out on the film surface on the cathode</p>

<p>&sect;1 node 8 corresponds to the place on the cathode film where delocalized anion (a2) is generated</p>

<p>&sect;1 node 9 corresponds to the bulk of the metal of the cathode.</p>

<p>&sect;1 Then the following circuit elements are connected in series:</p>

<p>&sect;1 RM11 + Re1 + ER1 + Rs1ox between node 0 and node 1 (this branch
...
<p>&sect;1 RM12 + EM1 + Rc1 between node 0 and node 2 (this branch of
...
<p>&sect;1 Rc1a1a1 + Efac1a1 + Rc1a1c1 between node 1 and node 2 (this
...
<p>&sect;1 Esa1 + Ras1 between node 1 and node 3 (this branch of the
...
<p>&sect;1 Esc1 + Ras2 between node 2 and node 4 (this branch of the
...
<p>&sect;1 Rc1sa1sa1s + Esc1sa1s + Rc1sa1sc1s between node 3 and node 4
...
<p>&sect;1 Rsc1sa2s + Esc1sa2s + Rsa2sc1s between node 4 and node 6
(this branch of the circuit describes the migration of the solvated cation c1s
...
<p>&sect;1 Rsa1sc2s + Esc2sa1s + Rsc2sa1s between node 3 and node 5
...
<p>&sect;1 Rc2sa2sc2s + Esc2sa2s + Rc2sa2sa2s between node 5 and node 6
(this branch of the circuit describes the migration of the solvated cation c2s
and anion a2s towards each other, in the solution, and their interaction. The
ionic pair c2sa2s is the result of this interaction)</p>

<p>&sect;1 Esc2 + Rcs3 between node 5 and node 7 (this branch of the
circuit describes the transfer of the solvent molecule to the places where
cation a2 goes out on the film surface on the cathode)</p>

<p>&sect;1 Esa2 + Rcs4 between node 6 and node 8 (this branch of the
circuit describes the transfer of the solvent molecule to the places where
anion a2 is formed on the film surface on the cathode) </p>

<p>&sect;1 Rc2a2a2 + Efcc2a2 + Rc2a2c2 between node 7 and node 8 (this
...
<p>&sect;1 RM21 + Re2 + ER2 + Rs2ox between node 8 and node 9 (this
...
<p>&sect;1 RM22 + EM2 + Rc2 between node 7 and node 9 (this branch of
...
<p>&sect;1 Ep + Rext between node 0 and node 9 (this branch of the
circuit describes an external circuit, that contains a pure resistance and the
source of an external polarization)</p>

<p>&sect;1 The author of the paper took into account following currents
flowing in this circuit:</p>

<p>&sect;1 current J1, flowing from node 0 to node 1, next to node 2
and finally to node 0 (this current describes the rate of the growth of the
corrosion product (c1a1) film on the anode);</p>

<p>&sect;1 current J2, flowing from the node 0 to node 1, then to node
...
<p>&sect;1 current J3, flowing from node 9 to node 8, next to node 7
and finally to node 9 (this current describes the rate of the growth of the
corrosion product (c2a2) film on the cathode);</p>

<p>&sect;1 current J4, flowing from the node 9 to node 8, then to node
...
<p>&sect;1 current J5, flowing from node 0 to node 1, then to node 3,
...
<p>&sect;1 current J6, flowing from the node 0 to node 9, then to node
...
<p>&sect;1 <b>End of description of Figure 1</b></p>

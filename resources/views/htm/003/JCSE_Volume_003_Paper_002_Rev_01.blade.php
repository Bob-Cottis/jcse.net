<h2>JCSE Volume 3, Paper 2</h2>
  <p><i><b>Submitted 16th March 2000, published for public review June 2000</b></i></p>
  <hr>
...
<h4>&sect;1 Abstract</h4>
  ...
  <p>&sect;2 <b>Keywords:</b> SQUID magnetometers, lap joints, corrosion measurement</p>
  <h3>1. Introduction</h3>
  <p>&sect;3 Corrosion of aircraft aluminium is a major problem for the United States
  ...
  <p>&sect;4 A limitation common to the existing corrosion measurement techniques is
  ...
  <p>&sect;5 Unlike the variety of techniques presently utilised, such as atmospheric
  ...
  <p>&sect;6 We have developed instrumentation, recording, and analysis techniques that
  ...
  <p>&sect;7 Four aluminium lap joint specimens were obtained from retired KC-135
  ...
  <p><img src="{{ $htmURL }}figure1.jpg" align="bottom" border="0" naturalsizeflag="3" width="527" height="321"></p>
  <p>&sect;8 <b>Figure 1: Schematic diagram of a typical lap joint specimen.</b></p>
  <h4>2.3 Corrosion Chambers</h4>
  <p>&sect;9 We designed environmental chambers that allowed us to expose lap joints to
  ...
  <p>&sect;10 To determine the chloride-dependence of corrosion within the lap joint, and
  ...
  <p>&sect;11 We define several useful magnetic field metrics in a previous paper [7].
  ...
  <table cellspacing="0" border="0" cellpadding="7" width="564">
    <tr>
      ...
      <td width="74%" valign="top"><img src="{{ $htmURL }}equation1.jpg" width="237" height="53"></td>
  ...
  <p>&sect;12 After recording a stable background, we introduced the corrosive solution
  ...
  <table cellspacing="0" border="0" cellpadding="7" width="564">
    <tr>
      <td width="14%" valign="top">&nbsp;</td>
      <td width="74%" valign="top"><img src="{{ $htmURL }}equation2.jpg" width="337" height="26"></td>
      <td width="12%" valign="top">
        <div align="right">
          (2)
        </div>
  ...
  <p>&sect;13 Furthermore, we define the Spatially Integrated Magnetic Activity (<i>SIMA</i>)
  as</p>
  <table cellspacing="0" border="0" cellpadding="7" width="564">
    <tr>
      <td width="14%" valign="top">&nbsp;</td>
      <td width="74%" valign="top"><img src="{{ $htmURL }}equation3.jpg" width="322" height="60">,</td>
      <td width="12%" valign="top">
        <div align="right">
          (3)
        </div>
  ...
  <p>&sect;14 Since <i>SIMA(t<sub>k</sub>,</i><font face="Symbol"><i>D</i></font><i>t)</i>
  ...
  <table cellspacing="0" border="0" cellpadding="7" width="564">
    <tr>
      <td width="14%" valign="top">&nbsp;</td>
      <td width="74%" valign="top"><img src="{{ $htmURL }}equation4.jpg" width="246" height="48"></td>
      <td width="12%" valign="top">
        <div align="right">
          (4)
        </div>
  ...
  <p>&sect;15 In the case where <i>SIMA</i> is proportional to mass-loss rate, <i>TSSIMA</i>
  should be proportional to the total mass-loss of the sample during the
  experiment.</p>
  <p>&sect;16 Finally, to determine the cumulative magnetic activity at each pixel for
  ...
  <table cellspacing="0" border="0" cellpadding="7" width="602">
    <tr>
      ...
      <td width="85%" valign="top"><img src="{{ $htmURL }}equation5.jpg" width="504" height="53"></td>
  ...
  <p>&sect;17 Before we computed final quantitative metrics, we processed the data to
  ...
  <p>&sect;18 We used a post-processing technique based on temporal-correlation to
  ...
  <table cellspacing="0" border="0" cellpadding="7" width="602">
    <tr>
      <td width="9%" valign="top">&nbsp;</td>
      <td width="85%" valign="top"><img src="{{ $htmURL }}equation6.jpg" width="301" height="50"></td>
      <td width="7%" valign="top">
        <div align="right">
          (6)
        </div>
  ...
  <p>&sect;19 All pixels whose cross-correlation with contamination exceeded a
  ...
  from the data.</p>
  <p>&sect;20 This procedure is demonstrated in Figure 2. Figure 2(a) is a <i>TSMA</i>
  ...
  <p><img src="{{ $htmURL }}figure2.jpg" align="bottom" border="0" naturalsizeflag="3" width="597" height="752"></p>
  <p>&sect;21 <b>Figure 2: (a) The <i>TSMA</i>&nbsp;image from lap-joint SM11-SP1. We
  ...
  <p>&sect;22 Our statistical analysis of the data involved a test of the significance on
  ...
  <p>&sect;23 We examined four KC-135 lap joints in Protocol III (Sample 11 Specimens 1
  ...
  <p><img src="{{ $htmURL }}figure3.jpg" align="bottom" border="0" naturalsizeflag="3" width="562" height="430"><br>
  <SCRIPT>comment(24)</SCRIPT><b>Figure 3: SIMA versus time curves obtained from KC-135 SM11-SP1.</b></p>
  <p><br>
  <img src="{{ $htmURL }}figure4.jpg" align="bottom" border="0" naturalsizeflag="3" width="562" height="430"><br>
  <b>Figure 4: SIMA versus time curves obtained from KC-135 SM11-SP2.</b></p>
  <p><br>
  <img src="{{ $htmURL }}figure5.jpg" align="bottom" border="0" naturalsizeflag="3" width="560" height="430"><br>
  <SCRIPT>comment(25)</SCRIPT><b>Figure 5: SIMA versus time curves obtained from KC-135 SM11-SP3.</b></p>
  <p><br>
  <img src="{{ $htmURL }}figure6.jpg" align="bottom" border="0" naturalsizeflag="3" width="560" height="430"><br>
  <SCRIPT>comment(26)</SCRIPT><b>Figure 6: SIMA versus time curves obtained from KC-135 SM11-SP4.</b></p>
  <p>&sect;27 For each lap joint, we calculated the average SIMA for the 24-hour period
  ...
  <p><img src="{{ $htmURL }}figure7.jpg" align="bottom" border="0" naturalsizeflag="3" width="560" height="388"></p>
  <p>&sect;28 <b>Figure 7: Average increases in activity upon humidification/immersion of
  ...
  <p>&sect;29 Table 3 shows the average <i>TSSIMA</i> obtained during each step for each
  ...
  <p><img src="{{ $htmURL }}figure8.jpg" align="bottom" border="0" naturalsizeflag="3" width="462" height="335"></p>
  <p>&sect;30 <b>Figure 8: TSSIMA data of KC-135 lap joint specimens averaged over three
  passes.</b></p>
  <p><img src="{{ $htmURL }}figure9.jpg" align="bottom" border="0" naturalsizeflag="3" width="483" height="387"></p>
  <p>&sect;31 <b>Figure 9: Average TSSIMA data of each step of Protocol III. Average
  ...
  <h4>4 Summary</h4>
  <p>&sect;32 We designed a protocol to determine the effects of moisture and chloride on
  ...
  humid air.</p>
  <p>&sect;33 Upon exposure to 0.1 M Cl<sup>-</sup>, we show chloride to generate
  ...
  <p>&sect;34 We have yet to obtain the calibration of mass-loss to magnetic-signal for
  ...
  joint geometry.</p>
  <p>&sect;35 Although magnetic contamination had been previously thought to be a
  ...
  <p>&sect;36 This work was funded in part through Air Force contract F09603-97-C-0050,

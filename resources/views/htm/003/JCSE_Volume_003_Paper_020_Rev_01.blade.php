<h2>JCSE Volume 3, Paper 20</h2>
  <p>Submitted 28th January 2002, published for public review 28th January 2002</p>
  <hr>
...
<p>&sect;2 Electrochemically, interest in
...
<p>&sect;3 Fe<sub>75-x</sub>Co<sub>x</sub>Cr<sub>1</sub>B<sub>7</sub>Si<sub>17</sub>
...
<p align=center>&sect;4 <img border=0 width=465 height=318
  src="{{ $htmURL }}./v3p20_files/image002.jpg"> </p>

<p align=center><b>Fig.1. Fe<sub>71</sub>Co<sub>4</sub>Cr<sub>1</sub>B<sub>7</sub>Si<sub>17</sub>
alloy X-ray diffraction</b> </p>

<p>&sect;5 The alloys were tested with a
...
src="{{ $htmURL }}./v3p20_files/image004.gif"></sub>���������������� [kg/m<sup>2</sup></span>�</span>h]����������������������� (1)</p>
...
src="{{ $htmURL }}./v3p20_files/image006.gif"></sub>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[m/year]������������������������ (2)</p>

<p>where: r</span> - material density.</p>

<p>&sect;6 The samples are very thin ribbons
(25-50 mm)
...
<p align=center><img border=0 width=488 height=364
  src="{{ $htmURL }}./v3p20_files/image008.jpg"></p>
  <p align=center>&sect;7 <b>Fig.2. Structure of amorphous ribbons (a, c)
  inner and (b, d) outer surfaces (a, b) before and (c, d) after corrosion</b></p>

<p>&sect;8 The following section will
...
by optical microscope, shows the above stated: </p>
  ...
  src="{{ $htmURL }}./v3p20_files/image010.jpg"></p>
  <p align=center>a)</p>
  <p align=center><img border=0 width=378 height=203
  src="{{ $htmURL }}./v3p20_files/image012.jpg"></p>
  <p align=center>b)</p>
  <p align=center><img border=0 width=459 height=220
  src="{{ $htmURL }}./v3p20_files/image014.jpg"></p>
  <p align=center>c)</p>
  <p align=center>&sect;9 <b>Fig.3.
...
<p>&sect;10 The surface of samples was also
...
src="{{ $htmURL }}./v3p20_files/image016.jpg"></p>

<p align=center>&sect;11 <b>Fig.4. Variation of penetration
coefficient depending on the cobalt concentration and the nature of the
aggressive medium.</b></p>

<p>&sect;12 The amorphous metallic alloys are
...
src="{{ $htmURL }}./v3p20_files/image018.jpg"></p>

<p align=center>&sect;16 <b>Fig.5. Variation in iron and cobalt dissolved in the 0.5N HCl etchant.</b></p>

<p>&sect;17 The Fe-Co-Cr-B-Si alloys are
...
<p>&sect;18 Fe<sub>75-x</sub>Co<sub>x</sub>Cr<sub>1</sub>B<sub>7</sub>Si<sub>17</sub>

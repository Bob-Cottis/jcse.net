...
<h3>&sect;1 Abstract</h3>
    ...
    <h3>Introduction</h3>
    <p>&sect;2 The initial sites of corrosion on organically coated alloy substrates are
    ...
    <p>&sect;3 Traditionally, the electrochemical investigation of organic coating
    ...
    <p>&sect;4 This paper presents several observations of local electrochemical events
    ...
    <p>&sect;5 The&nbsp; LEIM/S system used in this investigation employed the
    ...
    <p>&sect;6 All electrochemical measurements were performed on 1 mm thick AA2024-T3
    ...
    <p>&sect;7 All panels were cleaned prior to coating by the following procedure and
    ...
    <p>&sect;8 An important observation made in early investigations [15] was that
    ...
    <p>&sect;9 <b>Figure 1</b>:&nbsp; LEIM plots showing the differences in
    ...
    <p>&sect;10 It should be noted that these types of blister (i.e. red and black) were
    ...
    <p>&sect;11 <b>Figure 2</b>:&nbsp; Electron micrograph of a pitted region of the
    ...
    <p>&sect;12 It was hypothesized that LEIM/S could predict which initial defects might
    ...
    <p>&sect;13 <b>Figure 3</b>:&nbsp; LEIS shows that even in early stages, the red
    ...
    <p>&sect;14 In addition to differences in electrochemical activity, the blisters were
    ...
    <p>&sect;15 Differences in underfilm pH and potential also differentiate these
    ...
    <p>&sect;16 <b>Figure 4</b>:&nbsp; LEIM of the evolution of a red blister.&nbsp; Note
    ...
    <p>&sect;17 Red blisters generally show metastable behavior, with periods of
    ...
    <p>&sect;18 In later stages, metastability is visually observable as growth
    ...
    <p>&sect;19 Repassivation, or �healing� has been suggested to occur on chromate
    ...
    <p>&sect;20 <b>Figure 5</b>:&nbsp; LEIM of a red blister before and after a chromate
    ...
    image</a>)
    <p>&sect;21 Once the chromate was added, the open circuit potential rose to a more
    ...
    <p>&sect;22 &nbsp;In addition to characterizing overall properties of individual
    ...
    <p>&sect;23 <b>Figure 6</b>:&nbsp; An optical micrograph of a red blister with
    ...
    image</a>)
    <p>&sect;24 Energy dispersive spectroscopy (EDS) also revealed a higher amount of Cu
    ...
    <p>&sect;25 Whereas later stages of blister development can be characterized by
    ...
    <p>&sect;26 <b>Figure 7:</b>&nbsp; An example of the initial decrease in admittance,
    ...
    <p>&sect;27 Several explanations for this increase in impedance have been
    ...
    <p>&sect;28 <b>Figure 8</b>:&nbsp; The normal field is calculated theoretically for
    ...
    <h3>Conclusions</h3>
    <p>&sect;29 The local nature of corrosion of coated alloys necessitates the use of
    ...
    behavior.</p>
    <p>&sect;30 LEIM has identified several different types of defects on coated
    ...
    <p>&sect;31 The metastable nature of defects on the coated panels was monitored by
    ...
    <p>&sect;32 Red blisters were observed to initiate in a given region and branch into
    ...
    secondary lobes.</p>
    <p>&sect;33 LEIM revealed an initial increase in impedance of blisters in the
    ...
    <p>&sect;34 The authors would like to thank the Air Force Office of Scientific
    ...
    <h3>References</h3>
    <p>&sect;35 1.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; J.E.O. Mayne, D.J. Mills, <i>J. Oil Col

...
<h3>&sect;1 Abstract</h3>
  ...
  <p>&sect;2 <b>Keywords:</b> Silanes, E-coat, HSS, EIS, NMP, bis-amino, bis-polysulfur,
  RAIR, AFM</p>
  <h3>Introduction</h3>
  <p>&sect;3 Organofunctional silanes are hybrid organic-inorganic compounds that can be
  ...
  <p>&sect;4 The environmentally toxic properties of phosphates and chromate
  ...
  <p>&sect;5 &nbsp;The typical silanes are bis-organofunctional silanes viz.&nbsp;
  ...
  <p>&sect;6 In this paper, we have shown that silane-based pretreatments using either
  of both of these silanes can outperform the currently used phosphating
  treatments of automotive metal sheets</p>
  <p>&sect;7 After active hydrolysis with water, the bis-amino silane obtains the
  ...
  <h3>Experimental</h3>
  <p>&sect;8 The automotive materials of CRS, EGS, HDG, Al 6061 and Al 6111 were
  ...
  <p>&sect;9 The bis-amino silane having an amine functional group could be completely
  ...
  <p>&sect;10 The silanes after application were in-place cured or preferentially baked
  ...
  <p>&sect;11 In order to screen the silanes for performance and to reduce the 1000 hr
  ...
  <p>&sect;12 It has been reported earlier that the properties of the silane films on
  ...
  <p>&sect;13 The panels were also subjected to the GM Scab creep cyclic corrosion test
  ...
  <p>&sect;14 The chemical structures of the deposited silane films were studied by
  ...
  <p>&sect;15 AFM images of polished pure zinc substrates with and without silane films
  ...
  <p>&sect;16 While either of the above two silanes deposited on EGS, HDG and Al 6061
  ...
  <p>&sect;17 EIS has been shown to be a scientific method to study the corrosion
  ...
  <h4>RA-IR</h4>
  <p>&sect;18 The bis-amino and bis-polysulfur silane films were also characterized by
  ...
  <h4>AFM</h4>
  <p>&sect;19 Both the bis-functional silanes were analyzed using AFM.&nbsp; Figure 6
  ...
  <h3>Conclusions</h3>
  <p>&sect;20 A process consisting of coating thin films of organofunctional silanes on
  ...
  <h3>References</h3>
  <p>&sect;21 1. W.J. van Ooij and K.D. Conners, J. Electrochem. Soc., Vol. <u>95-13</u>,
  229 (1995)</p>
  ...
  <p>&nbsp;</p>
<p>&sect;22 <b>Table1: Hot Salt Soak Test Results<br>
...
<div align="center">
  ...
  <p>&sect;23 <b>Table 2: GM SCAB Creep Test Results<br>
...
<div align="center">
  ...
  <p>&sect;24 <b>Table 3: EIS of Electrocoated Automotive Steels</b></p>
<div align="center">
  <center>
  <table border="1" cellspacing="0" cellpadding="0">
    <tr>
  ...
  <p>&sect;25 <b>Figure 1: Hot salt soak test of e-coated EGS</b></p>
  <p><img border="0" src="{{ $htmURL }}fig2.gif" width="569" height="290"></p>
  <p>&sect;26 <b>Figure 2: Model for a corroding automotive metal with an electrocoat</b></p>
  <p><img border="0" src="{{ $htmURL }}v2p14_image004.jpg" width="648" height="367"></p>
  <p>&sect;27 <b>Fig. 3: IR Spectrum of bis-amino (2%, pH= 8.5) on polished Chrome Steel</b></p>
  <p><b><img border="0" src="{{ $htmURL }}v2p14_image006.jpg" width="648" height="371"></b></p>
  <p>&sect;28 <b>Fig. 4: IR spectrum of bis-polysulfur (5%, natural pH) on polished
  stainless steel</b></p>
  <p><img border="0" src="{{ $htmURL }}v2p14_image008.jpg" width="672" height="351"></p>
  <p>&sect;29 <b>Fig. 5: IR spectrum of bis-amino and bis-sulfur mixture (3:1) on
  polished stainless steel</b></p>
  <p><img border="0" src="{{ $htmURL }}fig6.jpg" width="579" height="320"></p>
  <p>&sect;30 <b>Figure 6: AFM image of a bis-polysulfur silane coated Zn surface</b></p>
  <p><img border="0" src="{{ $htmURL }}fig7.jpg" width="579" height="316"></p>
  <p>&sect;31 <b>Figure 7: AFM image of a bis-amino silane coated Zn surface</b></p>
  <p><img border="0" src="{{ $htmURL }}fig8.jpg" width="573" height="321"></p>
  <p>&sect;32 <b>Figure 8: AFM image of a bis-polysulfur silane coated Zn surface</b></p>
</SCRIPT>

<h2>JCSE Volume 2 Paper 2</h2>
  <b><i>Submitted 13<sup>th</sup> September 1999, published for public review 27<sup>th</sup>   October 1999</i></b>
  <hr align="LEFT">
  <h2>Amorphous Zirconia Films as Adhesion Promoter for Organic Coating</h2>
  F. J. Rodriguez<sup>�</sup>, L. Fedrizzi*, R. Di Maggio and S. Rossi&nbsp;<br>
  <i>Dipartimento di Ingegneria dei Materiali, Universit� degli Studi di Trento,
  Via Mesiano, 77, 38050 Trento, Italy, <u><script>mailto2('labaci','ing.unitn.it')</script>&nbsp;<br>
  </u>* Dipartimento di ICMMPM, Universit� di Roma I &quot;La Sapienza&quot;,
  Via Eudossiana, Roma, Italy<br>
  <sup>�</sup> Depto. Ingenieria Metalurgica, Facultad de Quimica, U.N.A.M.
  04510 Mexico D.F., Mexico, <script>mailto2('fxavier','servidor.unam.mx')</script>&nbsp;</i><br>
...
<p>&sect;2 <b>Keywords: </b>Organic coatings, Zirconia film, Adhesion, Pre-treatment.</p>
<h3>&sect;3 Introduction</h3>
  The most important properties of a protective coating are the anticorrosive
  action [1] and the adhesion to the substrate. The coatings act as barriers to
  ...
  substitute chromate pre-treatments [3]. On steel it has been employed iron or
  zinc or tricationic (Zn, Mn, Fe) phosphate [4]. The use of phosphate has shown
  ...
  On the other hand, ZrO<sub>2</sub>-CeO<sub>2 </sub>and other oxides films, put
  ...
  [7]. As an example the presence of complexing agent has already been shown to
  ...
  the formation of ZrO<sub>2</sub> films suitable as pretreatments promoting
...
<h3>&sect;4 Experimental</h3>
  ...
  conditions was measured by using a profilometer Dektak 3 [6]. The value was
  around 0.60&mu;m, but for series 4 and 5 it
  increased up to about 1.0 &mu;m. The series
  ...
  cost.&nbsp;
<p>&sect;5 <b>Table I.</b></p>
  <table border="1" cellspacing="1" cellpadding="4" width="624">
    <tr>
      <td width="9%" valign="TOP"><b>Series</b></td>
      <td width="13%" valign="TOP"><b>Alkoxide Molarity (g/mole)</b></td>
      <td width="10%" valign="TOP"><b>N� layers</b></td>
      <td width="17%" valign="TOP"><b>Chelating agent</b></td>
      <td width="17%" valign="TOP"><b>Temperature (�C)</b></td>
      <td width="11%" valign="TOP"><b>Time (min)</b></td>
      <td width="22%" valign="TOP"><b>Comment</b></td>
    </tr>
    <tr>
      <td width="9%" valign="TOP">1</td>
      <td width="13%" valign="TOP">0.3</td>
      <td width="10%" valign="TOP">3</td>
      <td width="17%" valign="TOP">Acetic acid</td>
      <td width="17%" valign="TOP">250</td>
      <td width="11%" valign="TOP">30</td>
    ...
    <tr>
      ...
      <td width="13%" valign="TOP">0.3</td>
      <td width="10%" valign="TOP">3</td>
      <td width="17%" valign="TOP">Acetylacetone</td>
      <td width="17%" valign="TOP">250</td>
      <td width="11%" valign="TOP">30</td>
      <td width="22%" valign="TOP">---</td>
    </tr>
    <tr>
      ...
      <td width="17%" valign="TOP">250</td>
      <td width="11%" valign="TOP">30</td>
      <td width="22%" valign="TOP">Treated in boiling water</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="69%" valign="TOP" colspan="5">&nbsp;</td>
      <td width="22%" valign="TOP">Degreased steel</td>
    </tr>
    <tr>
      <td width="9%" valign="TOP">10</td>
      <td width="69%" valign="TOP" colspan="5">&nbsp;</td>
      <td width="22%" valign="TOP">Tricationic phosphate</td>
    </tr>
    <tr>
      <td width="9%" valign="TOP">11</td>
      <td width="69%" valign="TOP" colspan="5">&nbsp;</td>
      <td width="22%" valign="TOP">Iron phosphate</td>
    </tr>
  </table>
  &nbsp;
<p>&sect;6 A multilayer polyester paint coating formed by a primer and a topcoat was
  applied in all cases. The average dry film thickness (DFT) was about 30 &mu;m.
  This kind of paint is usually used for electrical appliances [4]. A part of
  ...
  pyrrolidone [11]. The FTIR analyses were performed by a Spectrometer BioRad
  ...
  electrolyte was 0.3%wt. Na<sub>2</sub>SO<sub>4</sub>, because of its
  ...
  treated with the EQUIVCRT software [12].</p>
<h3>&sect;7 Results and discussion</h3>
  ...
  reached during the heating in air [10]. The IR spectra of all samples showed
...
<p>&sect;8 <b>Figure 1. Spectra IR of zirconia samples 1 and 3.&nbsp;</b></p>
<h4>&sect;9 Salt Fog Chamber (First Part)&nbsp;</h4>
  ...
  condensation and the formation of an oxide network [11]. At the aim of to
  ...
  appeared more suitable to adhere to the organic coating.&nbsp;</p>
<p>&sect;10 <b>Table II.</b></p>
  <table border="1" cellspacing="1" cellpadding="4" width="576">
    <tr>
      <td width="10%" valign="TOP">Series</td>
      <td width="19%" valign="TOP">Detachment after 7 days (mm)</td>
      <td width="21%" valign="TOP">Detachment after 21 days (mm)</td>
      <td width="50%" valign="TOP">Comments</td>
    </tr>
    <tr>
      <td width="10%" valign="TOP">1</td>
      <td width="19%" valign="TOP">0.3</td>
      <td width="21%" valign="TOP">0.7 (0.6 to 1)</td>
      <td width="50%" valign="TOP">No blistering</td>
    </tr>
    <tr>
      <td width="10%" valign="TOP">2</td>
      <td width="19%" valign="TOP">0.4</td>
      <td width="21%" valign="TOP">1.2 (1 to 1.3)</td>
      <td width="50%" valign="TOP">No blistering</td>
    </tr>
    <tr>
      <td width="10%" valign="TOP">3</td>
      <td width="19%" valign="TOP">0.5 (0.3 to 0.8)</td>
      <td width="21%" valign="TOP">2 (1.8 to 2.5)</td>
      <td width="50%" valign="TOP">Small blistering near the scratch</td>
    </tr>
    <tr>
      <td width="10%" valign="TOP">4</td>
      <td width="19%" valign="TOP">0.8 (0.5 to 1)</td>
      <td width="21%" valign="TOP">3.5 (3 to 4)</td>
      <td width="50%" valign="TOP">Total detachment after 21 days. There were
        large blisters all over the samples.</td>
    </tr>
    <tr>
      <td width="10%" valign="TOP">5</td>
      <td width="19%" valign="TOP">0.4</td>
      <td width="21%" valign="TOP">0.6 (0.5 to 1)</td>
      <td width="50%" valign="TOP">It was difficult to detach</td>
    </tr>
    <tr>
      <td width="10%" valign="TOP">6</td>
      <td width="19%" valign="TOP">1.5 (1 to 2)</td>
      <td width="21%" valign="TOP">---</td>
      <td width="50%" valign="TOP">After 7 days, all the paint was detached</td>
    </tr>
    <tr>
      <td width="10%" valign="TOP">7</td>
      <td width="19%" valign="TOP">0.6 (0.2 to 1)</td>
      <td width="21%" valign="TOP">1.8 (1 to 2)</td>
      <td width="50%" valign="TOP">Different detachment depending on the
        position in the cross scratch. Blistering</td>
    </tr>
    <tr>
      <td width="10%" valign="TOP">8</td>
      <td width="19%" valign="TOP">1.1 (0.5 to 1.8)</td>
      <td width="21%" valign="TOP">---</td>
      <td width="50%" valign="TOP">Disbonded area is brittle. Blistering</td>
    </tr>
    <tr>
      <td width="10%" valign="TOP">9</td>
      <td width="19%" valign="TOP">6.5</td>
      <td width="21%" valign="TOP">---</td>
      <td width="50%" valign="TOP">Blistering all over the sample</td>
    </tr>
    <tr>
      <td width="10%" valign="TOP">10</td>
      <td width="19%" valign="TOP">0</td>
      <td width="21%" valign="TOP">0.1 (0.1 to 0.2)</td>
      <td width="50%" valign="TOP">It was difficult to detach</td>
    </tr>
    <tr>
      <td width="10%" valign="TOP">11</td>
      <td width="19%" valign="TOP">0.4</td>
      <td width="21%" valign="TOP">2.5 (2 to 3)</td>
      <td width="50%" valign="TOP">There was blistering mainly near the
        cross-scratch</td>
    </tr>
  </table>
  &nbsp;
<p>&sect;11 It is remarkable that the series 5 along with series 1 resulted the best in
  ...
  phosphate looks the best option .</p>
<h3>&sect;12 Salt Fog Chamber Test (Second Part)</h3>
  <p>The results previous discussed brought about the further study was
  ...
  low temperature.&nbsp;</p>
<p>&sect;13 <b>Table III.</b></p>
  <table border="1" cellspacing="1" cellpadding="4" width="642">
    <tr>
      <td width="43" valign="TOP">Series</td>
      <td width="130" valign="TOP">Solution Molarity, Tmax and time of the
        thermal treatment</td>
      <td width="238" valign="TOP" colspan="4">Loss of adhesion (detachment from
        the scratch in mm)</td>
      <td width="179" valign="TOP">Comments*</td>
    </tr>
    <tr>
      <td width="43" valign="TOP">&nbsp;</td>
      <td width="130" valign="TOP">&nbsp;</td>
      <td width="49" valign="TOP">7 days</td>
      <td width="53" valign="TOP">13 days</td>
      <td width="52" valign="TOP">20 days</td>
      <td width="48" valign="TOP">27 days</td>
      <td width="179" valign="TOP">&nbsp;</td>
    </tr>
    <tr>
      <td width="43" valign="TOP">1</td>
      <td width="130" valign="TOP">0.3M, 250�C, 30&#146;</td>
      <td width="49" valign="TOP">0</td>
      <td width="53" valign="TOP">0</td>
      <td width="52" valign="TOP">&lt; 0.5</td>
      <td width="48" valign="TOP">&lt; 0.5</td>
      <td width="179" valign="TOP">Few blisters and corrosion in the scratch</td>
    </tr>
    <tr>
      <td width="43" valign="TOP">1&#146;</td>
      <td width="130" valign="TOP">0.3M, no heat treatment</td>
      <td width="49" valign="TOP">0</td>
      <td width="53" valign="TOP">5</td>
      <td width="52" valign="TOP">-</td>
      <td width="48" valign="TOP">-</td>
      <td width="179" valign="TOP">Completely covered with small blister</td>
    </tr>
    <tr>
      <td width="43" valign="TOP">5</td>
      <td width="130" valign="TOP">0.6M, 150�C, 30&#146;</td>
      <td width="49" valign="TOP">0</td>
      <td width="53" valign="TOP">0</td>
      <td width="52" valign="TOP">&lt; 0.5</td>
      <td width="48" valign="TOP">0.5</td>
      <td width="179" valign="TOP">Blisters and some points of rust in the
        scratch</td>
    </tr>
    <tr>
      <td width="43" valign="TOP">5&#146;</td>
      <td width="130" valign="TOP">0.6M, no heat treatment</td>
      <td width="49" valign="TOP">0</td>
      <td width="53" valign="TOP">2 &#150; 3</td>
      <td width="52" valign="TOP">-</td>
      <td width="48" valign="TOP">-</td>
      <td width="179" valign="TOP">Completely covered with small blister</td>
    </tr>
    <tr>
      <td width="43" valign="TOP">5&quot;</td>
      <td width="130" valign="TOP">0.6M, 250�C, 30&#146;</td>
      <td width="49" valign="TOP">0</td>
      <td width="53" valign="TOP">0</td>
      <td width="52" valign="TOP">&lt; 0.5</td>
      <td width="48" valign="TOP">&lt; 0.5</td>
      <td width="119" valign="TOP">Few small blisters and some points of rust in
        the scratch</td>
    </tr>
    <tr>
      <td width="43" valign="TOP">9</td>
      <td width="130" valign="TOP">Degreased steel</td>
      <td width="49" valign="TOP">9 &#150; 10</td>
      <td width="53" valign="TOP">-</td>
      <td width="52" valign="TOP">-</td>
      <td width="48" valign="TOP">-</td>
      <td width="179" valign="TOP">Large blisters near the cross-scratch</td>
    </tr>
    <tr>
      <td width="43" valign="TOP">10</td>
      <td width="130" valign="TOP">Tricationic phosphate</td>
      <td width="49" valign="TOP">0</td>
      <td width="53" valign="TOP">0</td>
      <td width="52" valign="TOP">0</td>
      <td width="48" valign="TOP">0</td>
      <td width="179" valign="TOP">First blistering after 27 days (small
        blisters). Few points in the scratch</td>
    </tr>
    <tr>
      <td width="43" valign="TOP">11</td>
      <td width="130" valign="TOP">Iron phosphate</td>
  ...
  * The comment refers to the appearance of the samples on the 27<sup>th</sup>
  day or when retired.<br>
  - Means that the samples were retired because of the total detachment of the
  coating.
<h4>&sect;14 Swelling with N-methyl pyrrolidone (NMP)</h4>
  <p>Van Ooij et al [7] have proposed the measure of the adhesion of the paint
...
<p>&sect;15 <b>Figure 2. FTIR spectra of series 1 before (A) and after immersion in NMP
  (B).</b></p>
  <p>&nbsp;<img src="{{ $htmURL }}image206.gif" WIDTH="764" HEIGHT="406"></p>
<p>&sect;16 <b>Figure 3. FTIR spectra of series 5 before (A) and after immersion in NMP
  (B).</b></p>
  ...
  better than the degreased steel.</p>
<h4>&sect;17 Pull-off test</h4>
  <p>The tests carried out with a pull-off device (Sebastian IV) have not been
  ...
  the substrate adhesion.</p>
<h4>&sect;18 Impedance measurements</h4>
  <p>Impedance measurements were performed in order to follow the progressive
  ...
  fitting of the impedance results was performed by Equivcrt software [9]. In
  ...
  components. Provoking larger defects (300 &mu;m) on
...
<p>&sect;19 <b>Figure 4. Detail (high frequency zone) of the Nyquist diagram of a
...
<p>&sect;20 <b>Figure 5. Nyquist diagram of a coated zirconia sample with an artificial
  defect (150 &mu;m).</b></p>
  <p><img border="0" src="{{ $htmURL }}v2p2.h3.gif" WIDTH="519" HEIGHT="354"></p>
<p>&sect;21 <b>Figure 6. Nyquist diagram of the coated zirconia sample with an
  artificial defect (300 &mu;m).</b></p>
<h3>&sect;22 Conclusions</h3>
  ...
  performance on adhesion of the ZrO<sub>2</sub> film. The N-methyl pyrrolidone
...
<h3>&sect;23 References</h3>
  1. H. Leidheiser, Jr., W. Funke, <i>J.Oil Colour Chem. Assoc</i>. 68, 121
  (1985).
  <p>2. F. Deflorian, L. Fedrizzi, <i>J. Adhesion Sci. Technol</i>. 13 (5),
  629-645 (1999).</p>
  <p>3. L.Benedetti, P.L. Bonora, M. Sassoli, Proceedings of Eurocoat 94 (Volume
  II), Sitges, Spain, 1994, p. 31-49.</p>
  <p>4. Werther Neri, <i>Introduzione alla Verniciatura delle Superfici
  Metalliche</i>, 3a. Edizione, Ed. Tecniche Nuove, Milano, 1990.</p>
  <p>5. M. Guglielmi, <i>J. Sol-Gel Sci. Technol</i>. 8, 443-449 (1997).</p>
  <p>6. R. Di Maggio, S. Rossi, L. Fedrizzi, P. Scardi, <i>Surface &amp;
  Coatings Technol</i>. 89, 292-298 (1997).</p>
  <p>7. C.J. Brinker and G.W. Scherer, <i>Sol-gel Science</i>, Academic Press,
  San Diego, 1990.</p>
  <p>8. D. Peter, T.S. Ertel and H. Bertagnolli, <i>J. Sol-Gel Sci. Technol</i>.
  5, 5-14 (1995).</p>
  <p>9. M.Chatry, M. Henry, M. In, C. Sanchez and J. Livage, <i>J. Sol-Gel Sci.
  Technol</i>. 1, 233-240 (1994).</p>
  <p>10. R. Di Maggio, R. Campostrini, G. Guella, <i>Chem. Mater.</i>, 10 (12)
  3839-3847 (1998).</p>
  <p>11.W.J.Van Ooij, R.A.Edwards, A.Sabata, J.Zappia, <i>J.Adhesion Sci.
  Technol</i>. 7 (8), 897-917 (1993).</p>
  <p>12.B. Boukamp, <i>Solid State Ionics</i>, 20, p. 31 (1986).</p>
</SCRIPT>

<h2>JCSE Volume 2 Paper 25</h2>
  <p><b><i>Submitted 13<sup>th</sup> September 1999, published for public review   29<sup>th</sup> October 1999</i></b></p>
  <hr>
...
<h3>&sect;1 Abstract</h3>
  ...
  test.</p>
  <p>&sect;2 <b>Keywords: </b>EIS, Artificial Perspiration, Lacquer Coatings, Zinc
  Electroplated Steel.</p>
  <h3>Introduction</h3>
  <p>&sect;3 Resistance to perspiration exposure is especially important for items
  ...
  <p>&sect;4 One testing method used to examine this problem is exposure to artificial
  ...
  <h3>Experimental</h3>
  <p>&sect;5 Three lacquer systems are discussed. These are representative of the
  ...
  <p>&sect;6 Samples of lacquer coated zinc electroplated steel (samples taken from
  ...
  <p>&sect;7 Samples were also examined using EIS spectroscopy, with testing undertaken
  ...
  rest potential.</p>
  <p>&sect;8 The high frequency coating response was determined from a Nyquist
  ...
  <h3>Results</h3>
  <p>&sect;9 The results of the conventional test are given in Table 2. The thin and
  ...
  <p>&sect;10 Figure 1 is an example of the Nyquist response obtained from lacquer C
  ...
  <p>&sect;11 Figure 2 shows the coating response of zinc electroplated steel coated with
  ...
  <h3>Discussion</h3>
  <p>&sect;12 Figure 1 shows an example of an EIS Nyquist response obtained from lacquer
  ...
  <p>&sect;13 From the coating resistance EIS results presented in Figure 2, it can be
  ...
  <p>&sect;14 Examining the conventional test results (Table 2), it can be noted that
  ...
  <p>&sect;15 The use of EIS as a supporting technique provides substantial advantages. A
  ...
  <p>&sect;16 We would like to thank Buko Ltd (Glenrothes, Scotland) for the support and
  ...
  <p align="center">&sect;17 <b>Table 2 Conventional ANSI artificial perspiration
  exposure test results.</b></p>
  <p><img src="{{ $htmURL }}image111.gif" WIDTH="487" HEIGHT="295"></p>
  <p>&sect;18 <b>Figure 1 EIS response for zinc electroplated steel coated with lacquer
  C, after exposure to ANSI artificial test solution for 60 minutes.</b></p>
  <p><img src="{{ $htmURL }}image112.gif" WIDTH="495" HEIGHT="296"></p>
  <p>&sect;19 <b>Figure 2 Mean values of coating resistance against exposure time for the

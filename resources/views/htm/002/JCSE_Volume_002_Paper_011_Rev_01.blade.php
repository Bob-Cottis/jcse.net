...
<p>&sect;2 In this paper are discussed some experimental results obtained on polyester
...
behaviour.</p>
<p>&sect;3 <b>Keywords: </b>Electrochemical Impedance Spectroscopy, salt spray test,
statistics, blistering.</p>
<h3>Introduction</h3>
<p>&sect;4 In many practical cases two, very different, testing methods are used for
...
<p>&sect;5 In the literature it is very frequent to find strong criticisms about the use
...
<p>&sect;6 This work is part of a larger project and it is devoted to the study of the
...
<p>&sect;7 Commercial protective coatings on phosphatised zinc electroplated steel,
...
<p>&sect;8 The samples characterised with electrochemical impedance spectroscopy were
...
<p>&sect;9 Impedance data were obtained on coated samples at the open circuit potential
...
<p>&sect;10 The samples after salt spray exposure were observed following the standard
...
<p>&sect;11 The blister dimension is defined as a number starting from 8 (small blisters)
  ...
  <table cellspacing="0" border="0" cellpadding="7" width="398">
    <tr>
      ...
      <td width="315" valign="TOP" align="center">
        <p>BI = <img src="{{ $htmURL }}image128.gif" alt="Sigma i=1 to 8 ni ai" align="middle" WIDTH="49" HEIGHT="45"></p>
      </td>
    </center>
...
<p>&sect;12 In equation 1 i is the blister dimension (from 8 to 1), n is the number of
...
<p>&sect;13 <b>Table 1: Blister coefficients</b></p>
<p><a href="../paper11/Image211.gif"><img src="{{ $htmURL }}image211_small.gif" border="2" WIDTH="400" HEIGHT="241"></a></p>
<p>&sect;14 <b>Figure 1: Blister index (BI)<script>ifscreen(' (click for a larger image)')</script>.</b></p>
<p><a href="../paper11/Image212.gif"><img src="{{ $htmURL }}image212_small.gif" border="2" WIDTH="400" HEIGHT="272"></a></p>
<p>&sect;15 <b>Figure 2: Coefficient of variation of the blister index<script>ifscreen(' (click for a larger image)')</script>.</b></p>
<p>&sect;16 In figure 1 is shown the trend with the immersion time of the average of the
...
<h4>EIS data.</h4>
<p>&sect;17 The experimental results obtained by EIS have been analysed using the
...
<p>&sect;18 The elements composing the circuit are the coating capacitance Qc (expressed
...
<p><img src="{{ $htmURL }}image213.gif" WIDTH="527" HEIGHT="314"></p>
<p>&sect;19 <b>Figure 3: Equivalent electrical circuit.</b></p>
<p>&sect;20 All the parameters have been obtained from fitting results with a relative
deviation (&chi;<sup>2</sup>) between the EIS
measurements and the fitting that is in general lower than 10<sup>-4 </sup>.</p>
<p>&sect;21 The mean values of each considered parameter are shown in figure 4 a,b,c and
...
parameters.</p>
<p>&sect;22 The Qc values increase during the initial period of immersion because of the
...
only a factor 6.</p>
<p><a href="../paper11/Image214.gif"><img src="{{ $htmURL }}image214_small.gif" border="2" WIDTH="400" HEIGHT="263"></a></p>
<p>&sect;23 <b>Figure 4a: Coating capacitance Qc<script>ifscreen(' (click for a larger image)')</script>.</b></p>
<p><a href="../paper11/Image215.gif"><img src="{{ $htmURL }}image215_small.gif" border="2" WIDTH="400" HEIGHT="257"></a></p>
<p>&sect;24 <b>Figure 4b: Pore resistance Rp<script>ifscreen(' (click for a larger image)')</script></b>.</p>
<p><a href="../paper11/Image216.gif"><img src="{{ $htmURL }}image216_small.gif" border="2" WIDTH="400" HEIGHT="245"></a></p>
<p>&sect;25 <b>Figure 4c: Double layer capacitance Qdl<script>ifscreen(' (click for a larger image)')</script>.</b></p>
<p><a href="../paper11/Image217.gif"><img src="{{ $htmURL }}image217_small.gif" border="2" WIDTH="400" HEIGHT="241"></a></p>
<p>&sect;26 <b>Figure 4d: Charge transfer resistance Rct<script>ifscreen(' (click for a larger image)')</script>.</b></p>
<p>&sect;27 As far as the data dispersion is concerned, we have calculated also in this
case the coefficient of variation. The results are shown in figure 5a, b and c.</p>
<p><a href="../paper11/Image218.gif"><img src="{{ $htmURL }}image218_small.gif" border="2" WIDTH="400" HEIGHT="259"></a></p>
<p>&sect;28 <b>Figure 5a: Coefficient of variation of the coating capacitance Qc<script>ifscreen(' (click for a larger image)')</script>.</b></p>
<p><a href="../paper11/Image219.gif"><img src="{{ $htmURL }}image219_small.gif" border="2" WIDTH="400" HEIGHT="256"></a></p>
<p>&sect;29 <b>Figure 5b: Coefficient of variation of the pore resistance Rp<script>ifscreen(' (click for a larger image)')</script>.</b></p>
<p><a href="../paper11/Image220.gif"><img src="{{ $htmURL }}image220_small.gif" border="2" WIDTH="400" HEIGHT="254"></a></p>
<p>&sect;30 <b>Figure 5c: Coefficients of variation of Rct and Qdl<script>ifscreen(' (click for a larger image)')</script>.</b></p>
<p>&sect;31 All the parameters, except the double layer capacitance, show a clear
...
<h3>Discussion</h3>
<p>&sect;32 A first very clear difference, comparing the testing results obtained by EIS
...
<p>&sect;33 A second very important aspect is the different trend of the coefficient of
...
blister index.</p>
<p>&sect;34 In general, when a system of data, obtained theoretically in identical way,
...
the single sample.</p>
<p>&sect;35 On the contrary if the data dispersion is independent of time it is always
...
system.</p>
<p>&sect;36 In other words the first system is dominated by defects which determine the
...
<p>&sect;37 In the case of salt spray test the main degradation morphology, and the only
...
<p>&sect;38 Completely different is the behaviour in the case of EIS characterisation
...
<p>&sect;39 The different behaviour of the coefficient of variation of double layer
...
<p>&sect;40 The only one element of the equivalent electrical circuit which can be
...
<p>&sect;41 In the case of EIS measurements moreover it is also important to remember
...
<p>&sect;42 Also the corrosion reaction (and therefore the specific charge transfer
...
<h3>Conclusions</h3>
<p>&sect;43 By testing organic coatings with salt spray exposure and EIS measurements it
...
<p>&sect;44 The degradation phenomena which it is possible to observe with EIS are

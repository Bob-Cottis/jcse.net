<h2>JCSE Volume 1 Paper 6</h2>
  <p><em>Submitted 6 February 1997, published 18 March 1999</em></p>
...
<p>&sect;3 There is a number of semi-empirical models which attempt to bridge the gap
...
<p>&sect;4 Since there are a lot of scattered experimental data on CO<sub>2</sub>
...
<p>&sect;5 Not many purely empirical models exist in the open literature. A
...
<p>&sect;6 Before the neural network model is described below, a brief description of
...
<h3>&sect;7 A Brief Description of the CO<sub>2</sub> Corrosion Process</h3>
...
<p>&sect;8 Aqueous CO<sub>2</sub> corrosion of carbon steel is an electrochemical
  process involving the anodic dissolution of iron and the cathodic evolution of
  hydrogen. The overall reaction is:</p>
  <p align="center"><img src="{{ $htmURL }}image84.gif" width="254" height="28"> (1<a name="overall"></a>)</p>
<p align="JUSTIFY">&sect;9 The electrochemical reactions are often accompanied by the
...
<p>&sect;10 The anodic dissolution of iron in acid solutions:</p>
  <p align="center"><img src="{{ $htmURL }}image85.gif" width="146" height="26"> (2<a name="anofe"></a>)</p>
...
<p align="JUSTIFY">&sect;11 On the cathodic side, it has been assumed that the presence
  ...
  <dir>
    <p align="center"><img src="{{ $htmURL }}image86.gif" width="133" height="30">(3<a name="hplusred"></a>)</p>
    <p align="center"><img src="{{ $htmURL }}image87.gif" width="243" height="31">(4<a name="carbacidred"></a>)</p>
    </dir>
<p align="JUSTIFY">&sect;12 It has been suggested<sup>14</sup> that in CO<sub>2</sub>
  solutions at higher pH the direct reduction of the bicarbonate ion becomes
  important:</p>
  <p align="center"><img src="{{ $htmURL }}image88.gif" width="244" height="30"><font face="Times"> (5<a name="bicarbred"></a>
  )</p>
  </font>
<h3>&sect;13 A Brief Description of the Artificial Intelligence Techniques Used</h3>
...
<p align="JUSTIFY">&sect;15 Neural networks can &quot;learn&quot; to forecast,
...
<p align="JUSTIFY">&sect;16 Neural network methods typically excel over traditional
  ...
  <p align="center"><img src="{{ $htmURL }}image89.gif" width="550" height="401"></p>
<p align="CENTER">&sect;17 <a name="_Ref378048808">Figure 1</a>. Back Propagation
  neural network.</p>
<p align="JUSTIFY">&sect;18 A Back Propagation neural network, used in the present
...
<p align="JUSTIFY">&sect;19 A complete set of training patterns presented to the neural
...
<p align="JUSTIFY">&sect;20 The unknown analytical form of evolved problem descriptors
...
<p align="JUSTIFY">&sect;21 Hence, the total number of input neurons <i>I</i> increases
...
<h4>&sect;22 Genetic Algorithms</h4>
...
<p align="JUSTIFY">&sect;23 M. Vrhovac<sup>16</sup> reported that selection of the
  ...
  of patterns.</p>
<p align="JUSTIFY">&sect;24 Genetic algorithms encode initial input data set
...
<p align="JUSTIFY">&sect;25 Genetic algorithms are robust. They perform well on
...
<h3>&sect;26 The Present Model</h3>
  ...
  m/s, pH 3.5 -7, CO<sub>2</sub> partial pressure <img src="{{ $htmURL }}image90.gif" width="41" height="30">=0.3-26
...
<p>&sect;27 Most of the experiments were conducted under conditions where protective
  ...
  <p align="center"></sup>
  <img src="{{ $htmURL }}image91.gif" alt="image91.gif (39662 bytes)" width="323" height="455"></p>
  <b>
<p align="center">&sect;28 <a name="_Ref378064611">Figure 2</a>. Artificial
  intelligence model for determination of the <i>V<sub>cor</sub></i> correlation</p></b>
<p>&sect;29 The total number of experiments presented by the authors<font face="Times" size="1">
...
<p>&sect;30 The model, consisted of a neural network and a genetic algorithm (Figure
  ...
  primitive descriptors (inputs):</p>
    ...
    <img src="{{ $htmURL }}image92.gif" width="39" height="30">- partial pressure of CO<sub>2</sub>,<br>
    <i>v</i> - velocity<br>
    pH</p>
  <p>and one output:</p>
    <i>
    <p>V<sub>cor</sub></i> - corrosion rate.</p>
<p align="JUSTIFY">&sect;31 Including the evolved descriptors, the final neural network
...
<p align="JUSTIFY">&sect;32 The training of the model was achieved in the following
  manner:</p>
  <ol>
...
<p align="JUSTIFY">&sect;33 Instead of randomly varying the order of patterns presented
...
<h3>&sect;34 Performance of the Model</h3>
...
<p>&sect;35 It should be pointed out that the selected empirical database<font face="Times" size="1">5</font>
...
<p>&sect;36 As shown in Figures 3-5, the SHELL, IFE and neural network models all show
...
<p>&sect;37 It is interesting that the predictions of the neural network for the
  ...
  <p align="center"><img src="{{ $htmURL }}image93.gif" width="671" height="559"></p>
  <b>
<p align="CENTER">&sect;38 <a name="_Ref348955993">Figure 3</a>. Comparison of the
  SHELL model with the KSC2 experimental data.</p>
  </b>
  <p align="center"><img src="{{ $htmURL }}image94.gif" width="671" height="561"></p>
  <b>
<p align="CENTER">&sect;39 <a name="_Ref348955997">Figure 4</a>. Comparison of the IFE
  model with the KSC2 experimental data.</p>
    </b>
    <p align="center"><img src="{{ $htmURL }}image95.gif" width="647" height="568"></p>
  <b>
<p align="CENTER">&sect;40 <a name="_Ref348955999">Figure 5</a>. Comparison of the
  neural network model with the KSC2 experimental data.</p>
    </b>
    <p align="center"><img src="{{ $htmURL }}image96.gif" width="671" height="561">&nbsp;</p>
  <b>
<p align="CENTER">&sect;41 <a name="_Ref350576341">Figure 6</a>. Comparison of the EC
  model with the KSC2 experimental data.</p>
  </b>
<h3>&sect;42 Conclusions</h3>
...
<h3>&sect;44 Acknowledgements</h3>

<h2>JCSE Volume 1 Paper 3</h2>
  <p>Submitted 22 June 1995, revised version submitted 9 November 1995<br>
...
src="{{ $htmURL }}v1p3_files/image002.gif" width="149" height="23"></span></sub></b>                                                 (1<a
name=hydrat></a>) </p>
<p>&sect;3 This weak, partly dissociated
...
<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image004.gif" width="148" height="23"></sub></b>                                                 (2<a
name=h2co3dis></a>)</p>
<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image006.gif" width="133" height="23"></span></sub></b>                                                     (3<a
name=hco3dis></a>) </p>
<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image008.gif" width="112" height="24"></span></sub></b>                                                          (4<a
name=hred></a>)</p>
<p>&sect;4 The other possibility is the
direct reduction of carbonic acid:<sup>2</sup></p>

<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image010.gif" width="195" height="25"></span></sub></b>                                     (5<a
name=h2co3red></a>)</p>

<p>&sect;5 When conducting potentiodynamic
...
<p align=center>&sect;8 <b>Table 1. <a name=steelcomp></a>Chemical composition of the St52
...
<p align=center><img
src="{{ $htmURL }}v1p3_files/image012.jpg" width="397" height="513"></span></p>

<p>&sect;9 <b><a name="_Ref326137986">Figure </a>1. 
...
<p align=center>&sect;13 <b>Table 2<a
...
<p align=center><img
src="{{ $htmURL }}v1p3_files/image014.gif" width="506" height="334"></p>

<p>&sect;15 <b><a name="_Ref326138138">Figure </a>2. 
...
<p align=center><img
src="{{ $htmURL }}v1p3_files/image016.gif" width="512" height="335"></p>

<p>&sect;16 <b><a name="_Ref326138219">Figure </a>3. Potentiodynamic sweep conducted in
a CO<sub>2</sub>
solution at pH 4, t=22 °C, 3% NaCl, using a rotating cylinder electrode d=1 cm.</b></p>

<p>&sect;17 In CO<sub>2</sub> solutions it was found<sup>3</sup>
...
<p>&sect;18 In the present study limiting
...
<p>&sect;19 If we assume that in CO<sub>2</sub> solution at pH 4, both the H<sup>+</sup> ions and H<sub>2</sub>CO<sub>3</sub> are reduced at the surface, then at a
...
<p align=center><img
src="{{ $htmURL }}v1p3_files/image018.gif" width="503" height="396"></span></p>

<p>&sect;20 <b><a name="_Ref325951260">Figure </a>4. Limiting currents for a CO<sub>2</sub> and a HCl
solution at pH4, t=22°C measured potentiostatically using a rotating cylinder
electrode d=1 cm.  </b> </p>

<h3>&sect;21 Discussion</h3>
...
<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image020.gif" width="191" height="28"></span></sub></b>                                               (6<a
name=hydlimcd></a>)</p>
...
<p align=center><img
src="{{ $htmURL }}v1p3_files/image022.gif" width="512" height="352"></p>

<p align=left>&sect;22 <b><a name="_Ref326129846">Figure </a>5. Thickness of the boundary layers
for pipe flow, t=20°C, pCO<sub>2</sub>=1 <i>bar</i>, d<sub>p</sub>=0.1m.</b>
</p>

<p align="center"><img
src="{{ $htmURL }}v1p3_files/image024.gif" width="512" height="353"></p>

<p align=left>&sect;23 <b><a name="_Ref326131584">Figure </a>6. Boundary layer thickness ratio as a
function of velocity and temperature for pipe flow, pCO<sub>2</sub>=1 <i>bar</i>, d<sub>p</sub>=0.1m.</b></p>

<p>&sect;24 The thickness
of the mass transfer (diffusion) layer<sub><img
src="{{ $htmURL }}v1p3_files/image026.gif" width="21" height="23"></sub> shown in Figure 5 is estimated by
using the relation:</p>

<p align=right><sub><img
src="{{ $htmURL }}v1p3_files/image028.gif" width="60" height="44"></sub>                                                             (7<a name="delta_m"></a>)  </p>
...
<sub><img
src="{{ $htmURL }}v1p3_files/image030.gif" width="19" height="21"></sub> is calculated using
the relation derived by Vetter</span><sup>10</sup> for a first
order chemical reaction: </p>

<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image032.gif" width="72" height="49"></span></sub></b>                                                          (8<a name="delta_r"></a>) </p>

<p align=left>where
<b><sub><img
src="{{ $htmURL }}v1p3_files/image034.gif" width="23" height="21"></span></sub></b>is the rate of carbonic acid dehydration (described in more
...
<img
src="{{ $htmURL }}v1p3_files/image036.gif" width="73" height="24"></sub> is a strong function
of temperature as shown in Figure 6.  It is clear that for lower temperatures <sub>
<img
src="{{ $htmURL }}v1p3_files/image038.gif" width="55" height="23"></sub> already for
...
<img
src="{{ $htmURL }}v1p3_files/image040.gif" width="47" height="23"></sub> ratio and covers a
wider range of applications.   </span></p>

<p>&sect;25 In order to
derive such an expression, we will assume here the following sequence of
reactions in the limiting current region:</p>

<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image042.gif" width="168" height="25"></span></sub></b>               slow
chemical reaction              (9<a
name=hydratslow></a>) </p>

<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image044.gif" width="195" height="25"></span></sub></b>         partial
electrode reaction(10<a
name=h2co3reda></a>)</p>

<p>&sect;26 If we further
assume that reaction (9) is a first order chemical reaction,
the rate of change of H<sub>2</sub>CO<sub>3</sub>
concentration is:</p>

<p align=right><sub><img
src="{{ $htmURL }}v1p3_files/image046.gif" width="137" height="41"></sub>                                                             (11<a name=rate1></a>) </p>

<p>&sect;27 We can assume
...
subscript<sub><img
src="{{ $htmURL }}v1p3_files/image048.gif" width="32" height="24"></sub> so (</span>11)  becomes:</p>

<p align=right><sub><img
src="{{ $htmURL }}v1p3_files/image050.gif" width="84" height="23"></sub>                                                                 (12<a name="rate_eq1"></a>) </p>

<p>&sect;28 At equilibrium
<i>v</i>=0 , hence:</p>

<p align=right><sub><img
src="{{ $htmURL }}v1p3_files/image052.gif" width="63" height="23"></sub>                                                                      (13<a name="rate_eq2"></a>) </p>

<p>where <sub><img
src="{{ $htmURL }}v1p3_files/image054.gif" width="13" height="17"></sub> is the equilibrium
concentration of H</span><sub>2</sub>CO<sub>3</sub>. Substitution of (13) into (12) gives:</p>

<p align=right><sub><img
src="{{ $htmURL }}v1p3_files/image056.gif" width="163" height="43"></sub>                                             (14<a name=rate2></a>) </p>
...
<p align=right><sub><img
src="{{ $htmURL }}v1p3_files/image058.gif" width="149" height="48"></sub>                                                (15<a name=fick1></a>) </p>

<p>For a steady
state case <sub><img
src="{{ $htmURL }}v1p3_files/image060.gif" width="75" height="21"></sub>.  We can further
assume that the diffusion coefficient is independent of concentration:<sub><img
src="{{ $htmURL }}v1p3_files/image062.gif" width="61" height="23"></sub>and that there are no temperature gradients so <sub>
<img
src="{{ $htmURL }}v1p3_files/image064.gif" width="63" height="23"></sub>.  Finally, by
substituting <i>v</i> from (</span>14)  into (15), the nondimensional steady
state mass balance is obtained:</p>

<p align=right> <sub><img
src="{{ $htmURL }}v1p3_files/image066.gif" width="128" height="47"></sub>                                                     (16<a name=fick2></a>)  </p>

<p>&sect;30 The boundary
conditions are:</p>
...
<p align=right><sub><img
src="{{ $htmURL }}v1p3_files/image068.gif" width="37" height="19"></sub>                            
Þ      <sub><img
src="{{ $htmURL }}v1p3_files/image070.gif" width="67" height="40"></sub>                                                  (17<a name=bc1></a>) </p>
...
<p align=right><sub><img
src="{{ $htmURL }}v1p3_files/image072.gif" width="47" height="23"></sub>                
Þ      <sub><img
src="{{ $htmURL }}v1p3_files/image074.gif" width="64" height="40"></sub>                                                   (18<a name=bc2></a>) </p>

<p>&sect;31 Here we have
assumed that the edge of the mass transfer boundary layer at <sub>
<img
src="{{ $htmURL }}v1p3_files/image075.gif" width="47" height="23"></sub> is the point where
...
<img
src="{{ $htmURL }}v1p3_files/image077.gif" width="48" height="16"></sub> that is “very far”
...
layer <sub><img
src="{{ $htmURL }}v1p3_files/image079.gif" width="23" height="23"></sub> is of the same order
of magnitude as the reaction layer which we are calculating.  Of course by setting <sub>
<img
src="{{ $htmURL }}v1p3_files/image081.gif" width="59" height="23"></sub> the present
derivation follows the one in Vetter’s<sup>10</sup>  book.</p>

<p>&sect;32 Integration of
(16) with the boundary conditions (17) and (18) yields the nondimensional
concentration profile:</p>

<p align=right><sub><img
src="{{ $htmURL }}v1p3_files/image083.gif" width="201" height="44"></sub>                                             (19<a name=concprof></a>) </p>

<p>We are
interested in the limiting current which is:</p>

<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image085.gif" width="364" height="49"></span></sub></b>              (20<a name=crlc1></a>) </p>

<p>When  <b><sub><img
src="{{ $htmURL }}v1p3_files/image087.gif" width="87" height="25"></span></sub></b> is returned to (20) we obtain:</p>

<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image089.gif" width="155" height="27"></span></sub></b>                                                        (21<a name=crlc2></a>) </p>
...
<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image091.gif" width="139" height="44"></span></sub></b>                                                   (22<a name=ff2></a>) </p>

<p>which takes
into account the effect of flow on the chemical reaction limiting current.  </p>

<p align=center><img
src="{{ $htmURL }}v1p3_files/image093.gif" width="514" height="370"></span></p>
...
<p>&sect;33 Assuming a
stagnant solution, <sub><img
src="{{ $htmURL }}v1p3_files/image095.gif" width="49" height="23"></sub>so the flow factor <i>f</i>=1
...
<p align=right><b><sub><img
src="{{ $htmURL }}v1p3_files/image097.gif" width="135" height="25"></span></sub></b>                                                    (23<a name=crlc3></a>)</p>
...
<p align=center><img
src="{{ $htmURL }}v1p3_files/image099.gif" width="503" height="396"></p>
...
<table border="0" cellpadding="2" cellspacing="1">
  ...
  <tr>
    <td width="18%">&nbsp;<sub><img
src="{{ $htmURL }}v1p3_files/image103.gif" width="13" height="17"></sub></td>
...
src="{{ $htmURL }}v1p3_files/image105.gif" width="13" height="13"></b></sub></td>
    <td width="82%"> Faraday constant (96490 <i>C/equiv.</i>);</td>
  </tr>
  <tr>
    <td width="18%"><sub><img
src="{{ $htmURL }}v1p3_files/image107.gif" width="21" height="24"></sub></td>
...
limiting current density, <i>A/m<sup>2
  ...
  <tr>
    <td width="18%"><sub><img
src="{{ $htmURL }}v1p3_files/image109.gif" width="16" height="21"></sub></td>
    <td width="82%"> forward
reaction rate (CO<sub>2</sub>hydration reaction), <i>1/s
  ...
  <tr>
    <td width="18%"><sub><img
src="{{ $htmURL }}v1p3_files/image110.gif" width="23" height="21"></sub></td>
...
surface, <i>m</i> ;</td>
  ...
  <tr>
    <td width="18%"><sub><img
src="{{ $htmURL }}v1p3_files/image111.gif" width="21" height="23"></sub></td>
    <td width="82%"> thickness
of the mass transfer (diffusion) layer, <i>m</i>;</td>
  </tr>
  <tr>
    <td width="18%"><sub><img
src="{{ $htmURL }}v1p3_files/image112.gif" width="19" height="21"></sub></td>
    <td width="82%"> thickness
of the chemical reaction layer, <i>m</i>;</td>
  </tr>
  <tr>
    <td width="18%"><sub><img
src="{{ $htmURL }}v1p3_files/image113.gif" width="73" height="24"></sub></td>

...
<title>JCSE Volume 1 Paper 10</title>
<SCRIPT src="/getcomm.php?vol=1&pap=10"></SCRIPT>
<SCRIPT src="/jsinc/jcsesubs.js.php"></SCRIPT>
<SCRIPT>
getcommentmode();</SCRIPT></HEAD><body>
<script src="/jsinc/writeheader.js"></script><?php ggl_ad(); ?>
  <h2>Volume 1 Paper 10</h2>
  <script>ifnotmode(3,'<p>Submitted 24 January 1999<br>');</script>
  <hr>
...
<SCRIPT>comment(2)</SCRIPT>  <p><strong>Keywords</strong>: Corrosion, ECN, CWT, time-frequency phase plane,
...
<SCRIPT>comment(4)</SCRIPT>  <p>Because of the simplicity of the test method, the ECN method has attracted
  ...
  identification.</p>
<SCRIPT>comment(5)</SCRIPT>  <p>Wavelets [7-11] are mathematical functions that cut up data into different
  ...
  signal processing.</p>
<SCRIPT>comment(6)</SCRIPT>  <p>Based on the above, the Wavelet Transform was tried to solve the problem.
...
<SCRIPT>comment(7)</SCRIPT>  <h3 align="left">2. Theory</h3>
  ...
  <p><img src="image25.gif" width="76" height="34"><img src="image26.gif" width="14" height="26">= <img src="image27.gif" width="150" height="63"><img src="image28.gif" width="16" height="33"><sup><img src="image28.gif" width="16" height="33"><img src="image29.gif" width="144" height="30"></p>
  </sup>
  <p>as continuous wavelets, with <img src="image30.gif" width="58" height="30"> as its &quot;mother
  wavelet&quot; if <img src="image30.gif" width="58" height="30"> is in the space of square integrable
  functions, and fulfills the equation</p>
  <p><img src="image31.gif" width="218" height="88"></p>
  <p>Here, <img src="image32.gif" width="56" height="48"> refers to the Fourier Transform of <img src="image30.gif" width="58" height="30">
  .</p>
<SCRIPT>comment(8)</SCRIPT>  <p>Therefore, we can define the continuous wavelet transform of a function as</p>
  <p> <i>Wf</i>(a,b) = <img src="image34.gif" width="281" height="39"></p>
  ...
  <dir>
    <p><img src="fig1.gif" alt="fig1.gif (6608 bytes)" width="664" height="391"></p>
  </dir>
<SCRIPT>comment(9)</SCRIPT>  <p><b>Fig1 Basis functions and the corresponding time-frequency resolution of
  Wavelet Transform: (a) basis functions, (b) the relevant representation of
  time-frequency phase plane map</b></p>
<SCRIPT>comment(10)</SCRIPT>  <p>The Continuous Wavelet Transform both has a deep mathematical background
  and is a practical algorithm with wide application in various fields. The
  above is just a very brief introduction.</p>
<SCRIPT>comment(11)</SCRIPT>  <h3>3. Experimental setup</h3>
...
<SCRIPT>comment(12)</SCRIPT>  <p>The basis of the measuring system was a multi-meter connected to a personal
...
<SCRIPT>comment(13)</SCRIPT>  <p><b>Table 1 Composition of Cements (Oxide content, wt-%)</b></p>
  <center>
...
<SCRIPT>comment(14)</SCRIPT>  <p><b>Table 2 Compositon of Steel</b></p>
  <center>
  <table border="1" cellspacing="2" bordercolor="#000000" cellpadding="9" width="717">
    <tr>
...
<SCRIPT>comment(15)</SCRIPT>  <h3 align="left">4. Results and discussion</h3>
  ...
  <p><img src="fig2a.gif" alt="fig2a.gif (9937 bytes)" width="537" height="358"></p>
<SCRIPT>comment(16)</SCRIPT>  <p><b>Fig.2 The ECN signal recorded for the corrosion of steel in reinforced
  concrete specimen in tap water</b></p>
<SCRIPT>comment(17)</SCRIPT>  <p>From Fig.2,We can see that due to the complicated and non-stationary nature
  ...
  <p><img src="fig3mor.jpg" alt="fig3mor.jpg (64403 bytes)" width="560" height="420"></p>
<SCRIPT>comment(18)</SCRIPT>  <p><b>Fig.3 The time-frequency phase plane representation for the recorded ECN
  signal of Fig.2</b></p>
<SCRIPT>comment(19)</SCRIPT>  <p>Fig.3 is the time-frequency phase plane representation for the recorded ECN
...
<SCRIPT>comment(20)</SCRIPT>  <p>From figure 3, it is seen that, when the scale is large, there are only few
...
<SCRIPT>comment(21)</SCRIPT>  <p>On the other hand, from figure 3, it is also seen that the signal has a
...
<SCRIPT>comment(22)</SCRIPT>  <p>From the above, we can see that corrosion process is most complicated, the

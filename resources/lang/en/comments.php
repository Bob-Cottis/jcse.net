...
return [
    ...
    'PA_NOTIFY_EMAIL_BODY'=>'<p>:authorName has made a comment on your paper number :pap in :jrnlShortName volume :vol. '.
        'The text of the comment is given below. This comment will be checked by an Editor to ensure that it not offensive '.
        '(but not for any technical matters). You may contact the <a href="mailto::edEmail">Editor</a>, but they will not wait '.

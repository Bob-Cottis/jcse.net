<h2>JCSE Volume 1 Paper 17</h2>
  <p><i>Submitted 19 July 1999, published for public review 2 November 1999</i></p>
  <hr>
...
<p>&sect;2 <b>Keywords:</b> Corrosion measurement, crevice corrosion, the wire beam
electrode</p>
...
experiments.</p>
<p>&sect;4 Crevice corrosion is a heterogeneous electrochemical process in nature. When
...
<p>&sect;5 To overcome some of the difficulties associated with conventional
...
<font size="2">
<p><img src="{{ $htmURL }}image167.gif" WIDTH="522" HEIGHT="492"></p>
</font>
<p>&sect;6 <b>Figure 1. A schematic diagram showing the WBE and its application in
crevice corrosion testing.</b></p>
<p>&sect;7 The WBE was initially developed and used to detect local defects in organic
...
processes [6, 8, 9].</p>
<p>&sect;8 This paper describes a simple crevice corrosion experiment. A wire beam
...
(1.8 cm <font face="Symbol">�</font> 1.8 cm). The total metallic area was
...
<p>&sect;11 The autoZRA was also connected in sequence between a chosen individual wire
...
<dir>
  <dir>
    ...
    - exp[- (<img src="{{ $htmURL }}image168.gif" align="middle" WIDTH="66" HEIGHT="42">)(E<font size="1">sys</font>
...
<p>&sect;13 Applying equation 1 to each wire in a WBE (wires 1 to 100), corrosion
...
<p>&sect;15 The potential and galvanic current distribution data were used to calculate
...
<p>&sect;16 With the extension of the electrode exposure, as shown in Figure 2, the
...
<p>&sect;17 The accumulative corrosion depth map (Figure 3a) correlates quite well with
...
<table border="1" width="100%">
  <tr>
    <td width="33%"><img src="{{ $htmURL }}image169.gif" align="left" WIDTH="339" HEIGHT="230"></td>
    <td width="33%"><img src="{{ $htmURL }}image170.gif" WIDTH="307" HEIGHT="228"></td>
    <td width="34%"><img src="{{ $htmURL }}image171.gif" WIDTH="286" HEIGHT="226"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="33%"><img src="{{ $htmURL }}image172.gif" align="left" WIDTH="337" HEIGHT="229"></td>
    <td width="33%"><img src="{{ $htmURL }}image173.gif" align="left" WIDTH="310" HEIGHT="230"></td>
    <td width="34%"><img src="{{ $htmURL }}image174.gif" align="left" WIDTH="322" HEIGHT="228"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="33%"><img src="{{ $htmURL }}image175.gif" WIDTH="334" HEIGHT="229"></td>
    <td width="33%"><img src="{{ $htmURL }}image176.gif" WIDTH="311" HEIGHT="227"></td>
    <td width="34%"><img src="{{ $htmURL }}image177.gif" WIDTH="323" HEIGHT="229"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="33%"><img src="{{ $htmURL }}image178.gif" WIDTH="332" HEIGHT="227"></td>
    <td width="33%"><img src="{{ $htmURL }}image179.gif" WIDTH="304" HEIGHT="227"></td>
    <td width="34%"><img src="{{ $htmURL }}image180.gif" WIDTH="325" HEIGHT="229"></td>
  </tr>
...
<p>&sect;18 <b>Figure 2. Galvanic current (in mA/cm<font size="1">2</font>), potential
...
<table border="1">
  <tr>
    <td width="50%"><font size="2"><img src="{{ $htmURL }}image181.gif" WIDTH="317" HEIGHT="212"></font></td>
    <td width="50%"><a href="image182.jpg"><img border="0" src="{{ $htmURL }}image182_s.jpg" width="350" height="323"></a></td>
  </tr>
  <tr>

...
<title>JCSE Volume 1 Paper 16</title>
<SCRIPT src="/getcomm.php?vol=1&pap=16"></SCRIPT>
<SCRIPT src="/jsinc/jcsesubs.js.php"></SCRIPT>
<SCRIPT>
getcommentmode();</SCRIPT></HEAD>
<body>
<script src="/jsinc/writeheader.js"></script><?php ggl_ad(); ?>
  <h2>Volume 1 Paper 16</h2>
  <script>ifnotmode(3,'<p><i>Submitted 5 June 1999, published for public review 29 October 1999</i></p>');</script>
  <hr>
...
<b>
<SCRIPT>comment(2)</SCRIPT><p>Keywords </b>active-passive transition, stochastic resonance,
bistability</p>
...
<SCRIPT>comment(4)</SCRIPT><p>The concept of stochastic resonance (SR) was first put
...
<SCRIPT>comment(5)</SCRIPT><p>In the research area of electrochemical reactions, much
...
<SCRIPT>comment(6)</SCRIPT><h3><b>Theoretical Aspects</h3>
</b>
...
<p><img src="image191.gif" WIDTH="273" HEIGHT="201"></p>
<SCRIPT>comment(7)</SCRIPT><p><b>Fig.1 Current-voltage curve for a 5mm diam. disk in 1M sulfuric acid,
rotating at 750rpm, taken from Epelboin et al</b></p>
<SCRIPT>comment(8)</SCRIPT><p>In the figure, the vertical line &quot;bf&quot; corresponds
...
follows:</p>
<p align="center"><img src="image192.gif" WIDTH="181" HEIGHT="32"></p>
...
<SCRIPT>comment(9)</SCRIPT><h4>2.&nbsp;&nbsp;&nbsp; The simple description of SR theory
[5,6,13,14,15]</h4>
<p>The mechanism of SR is simple to explain. Consider a heavily
damped particle mass <i>m</i> and viscous friction <img src="image67.gif" align="baseline" WIDTH="13" HEIGHT="17">,
...
<p align="CENTER"><img src="image68.gif" WIDTH="156" HEIGHT="45"> (2)</p>
<p>with <img src="image69.gif" align="baseline" WIDTH="106" HEIGHT="25"> being the
squared angular frequency of the potential minima at <img src="image70.gif" align="baseline" WIDTH="33" HEIGHT="24">,
and <img src="image71.gif" WIDTH="109" HEIGHT="26"> the squared angular frequency at the top of the
...
the temperature T.</p>
<SCRIPT>comment(10)</SCRIPT><p>If we apply a weak periodic forcing to the particle, the
...
<SCRIPT>comment(11)</SCRIPT><p>In summary, the effect requires three basic ingredients, (i)
...
<SCRIPT>comment(12)</SCRIPT><p>SR can be envisioned as a particular problem of signal
...
value.</p>
<SCRIPT>comment(13)</SCRIPT><h3><b>Results and discussion</h3>
</b>
...
<p align="CENTER"><img src="image193.gif" WIDTH="303" HEIGHT="32"></p>
...
<p><img src="image194.gif" WIDTH="531" HEIGHT="369"></p>
<SCRIPT>comment(14)</SCRIPT><p align="left"><b>Fig.2 The optimum output of the system after modulating the
noise amplitude to an optimum value</b></p>
<SCRIPT>comment(15)</SCRIPT><p>According to figure 2, when the noise amplitude was modified
...
<SCRIPT>comment(16)</SCRIPT><p>In order to further discuss the relationship between the
...
<p><img src="image195.gif" WIDTH="486" HEIGHT="319"></p>
<SCRIPT>comment(17)</SCRIPT><p><b>Fig.3 SNR-H curve for the output of the system</b></p>
<SCRIPT>comment(18)</SCRIPT><p>According to figure 3, it can be seen that there&#146;s a peak
...
<SCRIPT>comment(19)</SCRIPT><h3><b>Conclusion</b></h3>
...
<SCRIPT>comment(20)</SCRIPT><h3><b>References</h3>
<ul>
</b>

...
<title>JCSE Volume 3 Paper 4</title>
<SCRIPT src="/getcomm.php?vol=3&pap=4"></SCRIPT>
...
<script src="/jsinc/writeheader.js"></script><?php ggl_ad(); ?>
  ...
  <script>ifnotmode(3,'<p>Submitted 10th June 2000<br>');</script>
  <hr>
  ...
  <SCRIPT>comment(3)</SCRIPT><h3>The Model</h3>
  ...
  <SCRIPT>comment(5)</SCRIPT><p>In order to avoid artefacts associated with aliasing (due to sampling at a
  ...
  <SCRIPT>comment(6)</SCRIPT><p>The estimate of the time to the next pulse is based on the assumption that
  ...
  <SCRIPT>comment(7)</SCRIPT><h3>Implementation</h3>
  ...
  program</a>.</p>
  <SCRIPT>comment(8)</SCRIPT><h3>Performance</h3>
  ...
  <p><a href="v3p4_fig1.gif"><img border="2" src="v3p4_fig1_small.gif" width="400" height="273"></a></p>
  <SCRIPT>comment(9)</SCRIPT><p><b>Figure 1 Processing time for a simulation over 65536 seconds as a
  function of the expected number of pulses for a constant pulse amplitude. </b>(click
  on the image for an enlarged view)</p>
  <SCRIPT>comment(10)</SCRIPT><h3>Results</h3>
  ...
  <SCRIPT>comment(11)</SCRIPT><h4>Coefficient of Variation</h4>
  ...
  frequency below).</p>
  <p><a href="v3p4_fig2a.gif"><img border="2" src="v3p4_fig2a_small.gif" width="400" height="245"></a></p>
  <SCRIPT>comment(12)</SCRIPT><p><b>Figure 2a Effect of electrode asymmetry on coefficient of
  variation&nbsp;</b></p>
  <p><a href="v3p4_fig2b.gif"><img border="2" src="v3p4_fig2b_small.gif" width="400" height="245"></a></p>
  <SCRIPT>comment(13)</SCRIPT><p><b>Figure 2b Effect of electrode asymmetry on coefficient of variation
  (enlargement of y axis)</b></p>
  <SCRIPT>comment(14)</SCRIPT><h4>Localization Index</h4>
  ...
  <SCRIPT>comment(15)</SCRIPT><h4>Characteristic Charge</h4>
  ...
  <p><a href="v3p4_fig3.gif"><img border="2" src="v3p4_fig3_small.gif" alt="v3p4_fig3.gif (9427 bytes)" width="400" height="245"></a>&nbsp;</p>
  <SCRIPT>comment(16)</SCRIPT><p><b>Figure 3 Effect on sampling frequency (and hence measurement bandwidth)
  on estimated charge and pulse frequency</b></p>
  <SCRIPT>comment(17)</SCRIPT><p>Note that a large characteristic charge does not, of itself, indicate that
  ...
  <SCRIPT>comment(18)</SCRIPT><h4>Characteristic Frequency</h4>
  ...
  <SCRIPT>comment(19)</SCRIPT><p>When coupled with the estimate of the characteristic charge, the
  ...
  <SCRIPT>comment(20)</SCRIPT><h4>Roll-off Slope</h4>
  ...
  <SCRIPT>comment(21)</SCRIPT><h4>Skew</h4>
  ...
  <p><a href="v3p4_fig4.gif"><img border="2" src="v3p4_fig4_small.gif" width="400" height="245"></a></p>
  <SCRIPT>comment(22)</SCRIPT><p><b>Figure 4 Effect of electrode asymmetry on skew&nbsp;</b></p>
  <p><a href="v3p4_fig5.gif"><img border="2" src="v3p4_fig5_small.gif" width="400" height="246"></a></p>
  <SCRIPT>comment(23)</SCRIPT><p><b>Figure 5 Effect of mean inter-pulse interval on skew&nbsp;</b></p>
  ...
  <SCRIPT>comment(24)</SCRIPT><h4>Kurtosis</h4>
  ...
  <p><a href="v3p4_fig6.gif"><img border="2" src="v3p4_fig6_small.gif" width="400" height="245"></a></p>
  <SCRIPT>comment(25)</SCRIPT><p><b>Figure 6 Effect of electrode asymmetry on normalized kurtosis</b></p>
  <p><a href="v3p4_fig7a.gif"><img border="2" src="v3p4_fig7a_small.gif" width="400" height="246"></a></p>
  <SCRIPT>comment(26)</SCRIPT><p><b>Figure 7a Effect of mean inter-pulse interval on kurtosis</b></p>
  <p><a href="v3p4_fig7b.gif"><img border="2" src="v3p4_fig7b_small.gif" width="400" height="246"></a></p>
  <SCRIPT>comment(27)</SCRIPT><p><b>Figure 7b Effect of mean inter-pulse interval on kurtosis (enlarged y
  axis)</b></p>
  <SCRIPT>comment(28)</SCRIPT><h4>Noise Resistance and Impedance</h4>
  ...
  <SCRIPT>comment(29)</SCRIPT><p>Figure 8 shows a comparison of the measured electrochemical noise
  impedance, the set value of the double-layer capacitance, <i>C</i><sub><i>dl</i></sub>,
  and the expected value of <i>R<sub>ct</sub></i>.</p>
  <p><a href="v3p4_fig8.gif"><img border="2" src="v3p4_fig8_small.gif" width="400" height="245"></a></p>
  <SCRIPT>comment(30)</SCRIPT><p><b>Figure 8 Comparison of amplitude of impedance (average of 6 MEM spectra
  ...
  <SCRIPT>comment(35)</SCRIPT><h3>References</h3>
